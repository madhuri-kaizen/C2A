            ...
            <div className="relative w-full min-h-screen bg-white overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex flex-col h-full px-6 py-8">
                    <div className="mt-4 mb-6">
                        <h1
                            className="font-noto-serif font-normal capitalize text-[#f2c94c] mb-6"
                            style={{
                    ...
                    <div className="mt-60 mb-6">
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                            <p
                                className="text-[#1a2b5e] font-urbanist font-normal leading-relaxed"
                                style={{ fontSize: '18px', lineHeight: '24px', letterSpacing: '0px' }}
                            >
                                At Connect2Attorney, we help individuals find trusted, experienced attorneys who are committed to securing justice. Whether it's a personal injury claim, a class action lawsuit, or legal guidance, our team is here to support you through every step and make sure you get the help you deserve.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full max-w-7xl mx-auto flex flex-row relative">
                <div className="w-full lg:w-[60%] relative z-20 min-h-[750px] overflow-hidden">
                    ...
                    <div className="relative z-30 px-8 md:px-16 lg:pr-32 flex flex-col justify-center h-full pt-10 md:pt-0 md:-translate-y-6 lg:-translate-y-10">
                        ...
                        <div className="relative mt-4 lg:mt-6">
                            <h1
                                className="font-noto-serif font-normal capitalize leading-none mb-8 lg:mb-10"
                                style={{
                            ...
                            >
                                <span className="text-[#F5C844] block">About Us</span>
                            </h1>
                            ...
                            {/* Circular element positioned to the right */}
                            <div className="absolute top-1/2 right-0 lg:right-0 xl:right-0 -translate-y-12 z-40 translate-x-20 lg:translate-x-32 xl:translate-x-40">
                                <Image
                                    src="/AUTR.svg"
                        ...
                        <div 
                            ...
                            style={{
                                transform: 'translate(clamp(32px, 5vw, 96px), clamp(48px, 8vw, 152px))',
                ...
                <div className="w-full lg:w-[50%] relative z-10 -ml-28 overflow-hidden" style={{ clipPath: 'inset(0)' }}>
                    ...
                    <div className="absolute inset-0 w-full h-full overflow-hidden">
                        <div
                            className="relative z-30 pt-16 sm:pt-20 md:pt-24 lg:pt-28 pb-6 sm:pb-8 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 h-full flex flex-col justify-center items-start"
                            style={{ 
                                maxWidth: 'clamp(240px, 30vw, 380px)',
                                width: '100%',
                                marginLeft: 'auto',
                                marginRight: 'clamp(16px, 3vw, 40px)',
                                transform: 'translate(clamp(12px, 3vw, 32px), clamp(-140px, -20vh, -200px))'
                            }}
                        >
                            <p
                                className="text-[#162766] font-urbanist font-normal leading-relaxed break-words w-full"
                                style={{ 
                                    fontSize: 'clamp(14px, 1.3vw, 17px)', 
                                    lineHeight: 'clamp(20px, 1.8vw, 23px)', 
                                    letterSpacing: '0px',
