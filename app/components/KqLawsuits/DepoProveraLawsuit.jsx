...
const DepoProveraLawsuit = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "3179401705590481"; //last one : 1409965080153428
  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/depo-provera-lawsuit-a-kq",
        vertical: LEAD_GENERATION_VERTICALS.DEPO_PROVERA,
        formname: "Depo-Provera Lawsuit Lander A KQ",
  ...
  const sendToRetellCRM = async ({ payload }) => {
    try {
      ...
      const retellPayload = {
        ...
        websiteName: "Connect 2 Attorney",
        vertical: LEAD_GENERATION_VERTICALS.DEPO_PROVERA,
        formname: "Depo-Provera Lawsuit Lander Form A KQ",
        formPath: "/depo-provera-lawsuit-a-kq",
        data: {
          submissionDate: new Date().toLocaleString(),
...
py-20
    ...
    mb-4
      ...
      "
                >
                  Depo-Provera Lawsuit: Check Your Eligibility With  Connect 2 Attorney
                </h1>
...
"
                >
                  At  Connect 2 Attorney, we help you quickly find out whether you meet
...
"
                >
                  Check your eligibility for a Depo-Provera claim today
                </p>
              </div>
            </div>
    ...
    font-normal"
                      >
                        ...
                        <span>
                          ...
                          message, ai call from ai agents or mail regarding case
...
"
            >
              When you reach out to  Connect 2 Attorney for a Depo-Provera <br />{" "}
...
"
    ...
    mx-auto"
                >
                  Complete a short, secure form focused on your Depo-Provera use
...
"
    ...
    mx-auto"
                >
                  Your details are carefully evaluated to determine if you meet
                  the criteria for a Depo-Provera lawsuit.
                </p>
              </div>
  ...
  "
            ...
            <div className="relative">
              ...
              >
                {[
                  {
                    text: "I didn't realize Depo-Provera use could cause a brain tumor.  Connect 2 Attorney explained my legal options clearly and connected me with the right attorney, informed, confident, and supported.",
                    name: "Emily R.",
                  },
                  {
                    text: "After my Depo-Provera diagnosis,  Connect 2 Attorney guided me through eligibility and connected me with a supportive attorney. The process was simple and reassuring during a very difficult time.",
                    name: "Sarah M.",
                  },
                  {
                    text: "Diagnosed with meningioma after Depo-Provera use, I contacted  Connect 2 Attorney. They quickly lined up my options and connected me with an attorney and guided me toward justice and compensation.",
                    name: "Nicole D.",
                  },
                ].map((item, idx) => (
                  <div
...
"
  ...
  "
              >
                 Connect 2 Attorney focuses on helping people affected by dangerous or
...
"
              >
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on
...
"
          >
            At  Connect 2 Attorney, we help you quickly find out whether you meet the
...
"
                >
                  <span className="font-bold">Q</span> {i + 1}. {q}
                </p>
 ...
 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
  ...
  "
          >
            {" "}
            When you reach out to  Connect 2 Attorney for a Depo-Provera lawsuit
  ...
  "
            >
              Complete a short, secure form focused on your Depo-Provera use and
  ...
  "
            >
              "I didn't know my Depo-Provera use could cause a brain tumor.
               Connect 2 Attorney explained claims clearly and connected me with the
...
"
  ...
  "
            >
              "After my Depo-Provera diagnosis,  Connect 2 Attorney guided me through
  ...
  "
            >
              "Diagnosed with meningioma after Depo-SubQ Provera, I turned to
               Connect 2 Attorney. They quickly linked me to an experienced attorney
  ...
  "
          >
            ...
            <li className="flex gap-3">
              ...
              <span>
                We use clear, criteria-based screening focused on Depo-Provera
                and meningioma claims.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
...
export default DepoProveraLawsuit;
