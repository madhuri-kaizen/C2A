    ...
    const createEarlyLead = async ({ fullName, phone, email = "" }) => {
        ...
        try {
            ...
            const body = {
                ...
                formPath: "/dupixent-lawsuit-a-kq",
                vertical: LEAD_GENERATION_VERTICALS.DUPIXENT,
                formname: "Dupixent Lawsuit A Lander KQ",
                        ...
                        <div className="pt-20 pb-5 mt-20 text-white flex justify-center">
                            <div className=" max-w-[720px]">
                                <h1 className="text-[52px] leading-tight font-semibold mb-4">
                                    Dupixent Lawsuit: Check Your Eligibility with Connect 2 Attorney
                                </h1>
                ...
                <section className="w-full bg-white py-10">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        ...
                        <p className="text-[18px] text-[#4B5563] max-w-[620px] mx-auto leading-relaxed">
                            When you reach out to Connect 2 Attorney for a Dupixent lawsuit<br /> review, we make the process simple, secure, and focused<br />
                            on your situation:
                        </p>
...
"
                ...
                "
                            ...
                            >
                                {[
                                    {
                                        text: " I didn’t realize my symptoms could be linked to Dupixent. Connect 2 Attorney helped me understand my options clearly and connected me with the right attorney. I finally felt informed and supported.”  ",
                                        name: "Emily R.",
                                    },
                                    {
                                        text: "After my diagnosis, I had so many questions. Connect 2 Attorney guided me through the eligibility process and made everything simple during a difficult time.",
                                        name: "Sarah M.",
                                    },
                                    {
                                        text: "I didn’t know my symptoms could be linked to Dupixent. Connect 2 Attorney helped me understand my options and take the right next step.",
                                        name: "Michael T.",
                                    },
                                ].map((item, idx) => (
                                    <div
                    ...
                    <div className="max-w-[1200px] mx-auto px-6  grid grid-cols-2 gap-16 items-stretch">
                        <div>
                            ...
                            <p className="text-[18px] leading-[26px] text-[#555555] max-w-[540px] mb-3">
                                Connect 2 Attorney focuses on helping individuals affected by dangerous or harmful drugs like Dupixent. Connect with legal professionals who understand complex cases such as Dupixent lawsuit claims.
                            </p>
                        ...
                        <div className="flex flex-col gap-[16px]">
                            ...
                            {[
                                ...
                                },
                                {
                                    ...
                                    answer: "You can begin by submitting a free case review. Connect 2 Attorney will evaluate your eligibility and connect you with an attorney experienced in handling Dupixent Lymphoma lawsuit claims.",
                                },
                            ].map((faq, index) => {
...
>
  ...
  className="
    ...
    mb-10
  "
>                        When you reach out to Connect 2 Attorney for a Dupixent lawsuit review, we make the process simple, secure, and focused
                        on your situation:
                    </p>
...
>                        Hear from people, <br />
  ...
  "
>
                            “I didn’t realize my symptoms could be linked to Dupixent. Connect 2 Attorney helped me understand my options clearly and connected me with the right attorney. I finally felt informed and supported.”
                        </p>
...
">patient</p>
  ...
  "
>
                            “After my diagnosis, I had so many questions. Connect 2 Attorney guided me through the eligibility process and made everything simple during a difficult time.”
                        </p>
...
">patient</p>
  ...
  "
>
                            “I didn’t know my symptoms could be linked to Dupixent. Connect 2 Attorney helped me understand my options and take the right next step.”
                        </p>
