  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/hernia-mesh-lawsuit-d-kq",
        vertical: LEAD_GENERATION_VERTICALS.HERNIA_MESH,
        formname: "Hernia Mesh Lawsuit Form D KQ",
            ...
            <div className="pt-0 mt-20 text-white flex justify-center">
              <div className=" max-w-[720px]">
                 <h1 className="text-[32px] sm:text-[34px] md:text-[38px] lg:text-[42px] xl:text-[46px] leading-snug font-semibold mb-4">
                   Hernia Mesh Lawsuit: Complications After Implant See If <span className="bg-[#162766] text-[#F8D216] px-3 py-[3px] rounded-md inline-block">
                       You Qualify
                    </span>
                ...
                <p className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed tracking-wide text-white mb-4">
                  Patients across the U.S. are filing hernia mesh claims after serious complications like mesh failure, chronic pain, infection, adhesion, or bowel obstruction, often requiring revision or removal surgery.    
                </p>
                 ...
                 <ul className="mt-6 space-y-4 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] xl:text-[19px] text-white">
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                        You had a <span className="font-semibold">hernia mesh implant surgery</span> 
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                         You experienced <span className="font-semibold">complications</span>
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                         You needed <span className="font-semibold">revision, removal, </span> or
                          <span className="font-semibold"> repair surgery </span>
                        </span>
                    </li>
                </ul>
              </div>
...
">
                ...
                What a Hernia Mesh Lawsuit Claim May Include 
                </h2>
                ...
                If your hernia mesh caused serious complications, especially if you needed 
                revision or removal surgery, you may be entitled to compensation for the 
                medical and personal impact.    
                <span className="font-semibold"> Claims often seek damages for: </span> 
                </p>
                ...
                <li className="flex items-start gap-2">
                    ...
                    Revision/removal surgery costs and related hospital bills 
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Ongoing treatment (imaging, medications, specialist care)  
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                ...
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Out-of-pocket expenses (travel, home care, recovery needs)  
                </li>
                </ul>

                {/* ===== SECTION 2 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                Hernia Mesh Complication Claims Rise as Patients Report Pain, Migration, and Repeat Surgeries 
                </h3>
                ...
                <p>
                    Thousands of patients report long-term complications after hernia mesh implantation, including chronic pain, infection, adhesions, and mesh failure. 
                </p>

                <p>
                    Many claims involve allegations that certain mesh products were defectively designed or inadequately warned about risks like migration, shrinkage, erosion, or bowel obstruction. 
                </p>

                <p>
                    Eligibility often depends on documentation of complications, especially when a surgeon recommends or performs revision, removal, or repeat hernia repair surgery.  
                </p>

                <p>
                    Because legal deadlines vary by state, completing a quick confidential screening is the fastest way to confirm whether you still have time to file. 
                </p>
                </div>

                {/* ===== SECTION 3 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                Common Hernia Mesh Complications Reported by Patients 
                </h3>
                ...
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Adhesions (scar tissue binding)  
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Erosion or organ damage
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Bowel obstruction 
...
/>
        ...
        <div className="px-4 pt-12 pb-16 text-white">
            ...
            Complications After Implant See If
             {"  "}{"  "}
 ...
 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
      ...
      <div className=" lg:hidden w-full bg-[#162766]">
            <div className=" max-w-[720px] px-4 py-10 text-white font-jakarta">
                ...
                <li className="flex items-start gap-3">
                    ...
                    <span>
                     You needed  <span className="font-semibold">revision, removal </span> or <span className="font-semibold">repair surgery </span>
                    </span>
                </li>
                </ul>
            </div>
      ...
      <section className=" lg:hidden w-full bg-white py-10">
            <div className="px-4 font-jakarta text-[#162766]">
                ...
                What a Talcum Powder Lawsuit Claim May Include
                </h2>

                <div className="w-full h-0.5 bg-[#e7e9ec] mb-4" />

                <p className="text-[16px] leading-[1.7] text-[#5A627A] mb-4">
                If your hernia mesh caused serious complications, especially 
                if you needed revision or removal surgery, you may be 
                entitled to compensation for the medical and personal impact. 
                  
                <span className="font-bold">Claims often seek damages for: </span>  
                </p>
                ...
                <h3 className="text-[24px] font-bold mb-4 leading-snug">
                  Hernia Mesh Complication Claims Rise as Patients Report Pain, Migration, and Repeat Surgeries                 </h3>
...
export default HerniaMeshLawsuitD;
