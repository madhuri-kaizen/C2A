...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/ozempic-lawsuit-a-kq",
      vertical: LEAD_GENERATION_VERTICALS.OZEMPIC,
      formname: "Ozempic Lawsuit lander Form A KQ",
...
">
                  ...
                  you may be entitled to compensation.  Connect 2 Attorney 
...
">
                  Get Your Free Case Review Today. Take Action Now!
                </p>
              </div>
            </div>
...
lg:text-[16px]
 ${
  ...
  {
    q: "Q2. Have you taken GLP-1 medications such as Ozempic, Wegovy, Rybelsus, Trulicity, Mounjaro, or Zephound?",
    name: "q2",
  },
  {
...
">
    ...
    mx-auto
">
              When you reach out to  Connect 2 Attorney for an Ozempic <br /> lawsuit review, the
...
">
    ...
    max-w-[260px]
    mx-auto">
                  Complete a short, secure form focused on your Ozempic use and the complications it caused.
                </p>
              </div>
...
">
    ...
    max-w-[260px]
    mx-auto">
                  Your details are carefully evaluated to determine if you meet the criteria for
                  an Ozempic lawsuit.
                </p>
              </div>
...
mb-7">
            ...
            <div className="relative">
              ...
              >
                {[
                  {
                    text: " Connect 2 Attorney supported me after my Ozempic complications. They connected me with an attorney who handled my case professionally and helped me pursue the compensaion I deserved.",
                    name: "Lisa K.",
                  },
                  {
                    text: "After experiencing severe side effects from Ozempic,  Connect 2 Attorney connected me with a knowledgeable attorney. Their guidance made the claim process simple, clear, and stress-free.",
                    name: "Jennifer T.",
                  },
                  {
                    text: "I didn't know Ozempic could cause serious health issues.  Connect 2 Attorney helped me understand my legal options and guided me to an experienced attorney for my lawsuit.",
                    name: "Michael R.",
                  },
                ].map((item, idx) => (
                  <div
...
">Patient</p>
 ...
 ">
    ...
    mb-3
">
                 Connect 2 Attorney focuses on helping people affected by dangerous or harmful
...
">
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on Ozempic-caused complications
                    claims.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    We connect qualified individuals with attorneys in pharmaceutical injury
                    litigation.
                  </span>
                </li>
...
">
            If you or a loved one experienced severe side effects from Ozempic, you may be entitled to compensation.
             Connect 2 Attorney connects you with trusted attorneys who specialize in
...
>
            ...
            What Happens <br /> When You Contact <br />  Connect 2 Attorney?
          </h2>
...
<p
  className="
    ...
    mb-10
  "
>            When you reach out to  Connect 2 Attorney for an Ozempic lawsuit review, the
            process is simple and fast:
          </p>
...
<p
  ...
  "
>
              Your details are carefully evaluated to determine if it meets the criteria for an
              Ozempic lawsuit.
            </p>
          </div>
...
<p
  ...
  "
>
               Connect 2 Attorney supported me after my Ozempic complications. They handled my case 
...
<p
  ...
  "
>
              After experiencing severe side effects from Ozempic,  Connect 2 Attorney connected me with a
...
<p
  ...
  "
>
              I didn't know Ozempic could cause serious health issues.  Connect 2 Attorney helped me
...
<p
  className="
    ...
    mb-5
  "
>             Connect 2 Attorney focuses on helping people affected by dangerous or harmful products
...
>            <li className="flex gap-3">
              ...
              <span>
                We use clear, criteria-based screening focused on Ozempic-caused complications claims.
              </span>
            </li>
