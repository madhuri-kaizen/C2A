...
const womanHair = "/Form/womanhair.png";
const lawyerReading = "/Form/lawyerreading.png";
  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/hair-relaxer-lawsuit-b-kq",
        vertical: LEAD_GENERATION_VERTICALS.HAIR_RELAXER,
        formname: "Hair Relaxer Lawsuit Form B KQ",
...
py-20
  ...
  "
                >
                  ...
                  <span className="text-[#F8D216]">Check If</span>
                  <br />
...
"
                >
                  ...
                  <br />
                  <br />
                  Our platform makes it simple and confidential to connect with
                  experienced hair relaxer lawsuit attorneys who understand the
                  science, the products, and the legal claims behind this
                  growing litigation.
                  <br />
                  <br />
                  ...
                  ✅ Fast attorney matching nationwide <br />
                  ✅ No upfront fees to check your eligibility <br />
                  ✅ Dedicated support for hair relaxer cancer claims <br />{" "}
                  <br />
                </p>
...
leading-tight font-semibold text-[#162766] mb-4"
              >
                About Hair Relaxers and the Hair Relaxer
                <br />
                Lawsuit
              </h2>
...
"
              >
                Hair relaxers are chemical hair-straightening products widely
                used on naturally curly or textured hair and heavily marketed to
                women. Many of these products have potentially harmful chemicals
                such as formaldehyde and phthalates.
              </p>
...
"
              >
                Studies and patient reports suggest a possible link between
...
"
              >
                Eligibility for Hair Relaxer Lawsuit Compensation
              </h2>
...
"
              >
                You may qualify for a hair relaxer cancer lawsuit if the
...
"
              >
                <li className="flex gap-3">
                  ●
                  <span>
                    You were diagnosed in 2010 or later with one of the
                    following cancers: ovarian cancer (including serous,
                    endometrioid, mucinous, clear cell, undifferentiated, or
                    unknown subtype), endometrial cancer
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    You were 59 years old or younger at the time of diagnosis.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    You used a hair relaxer product continuously for at least
                    four years before your diagnosis.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    During your highest use period, you used the product at
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    Your diagnosis occurred within 10 years of your last hair
                    relaxer use.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    You know the brand you used, and it contained formaldehyde
                    or phthalates.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    For wrongful-death claims, the statute of limitations must
                    not be within 90 days of expiring.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    <strong>Accepted hair relaxer brands include: </strong>
                    Africa’s Best, Ultra Precise, Bantu, TCB Naturals, Dark &
                    Lovely, Luster’s, Just For Me, Mizani Relaxer, Motions,
                    Optimum, Organic Root Stimulator (ORS Olive Oil – when mixed
                    with a relaxer), Soft & Beautiful, and African Pride.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  ●
                  <span>
                    If another brand was used, you must know the exact product
                    name and confirm that it contained formaldehyde or
                    phthalates.
                  </span>
                </li>
              </ul>
...
font-lato
    ...
    xl:text-[17px]">
                ...
                our quick, confidential form to see if you qualify for a hair
                relaxer lawsuit. Our experienced attorneys will review your case
                for free and guide you through the process.
              </p>
...
leading-relaxed
 text-[#162766] mb-2"
  ...
  "
                >
                  Get matched with experienced hair relaxer lawyers.
                </p>
              </div>
...
"
          >
            Our platform makes it simple and confidential to connect with
            experienced hair relaxer lawsuit attorneys who understand the
            science, the products, and the legal claims behind this growing
            litigation.
          </p>
        </div>
      </div>
...
"
 ...
 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
  ...
  "
          >
            {" "}
            About Hair Relaxer and the Hair Relaxer Lawsuit
          </h2>
  ...
  "
          >
            Hair relaxers are chemical hair-straightening products widely used
            on naturally curly or textured hair and heavily marketed to women.
            Many of these products have potentially harmful chemicals such as
...
md:leading-[46px]
  ...
  "
          >
            You may qualify for a hair relaxer cancer lawsuit if the following
            conditions apply:
          </p>
  ...
  "
          >
            ...
            <li className="flex gap-3">
              ●
              <span>
                You were diagnosed in 2010 or later with one of the following
                cancers: ovarian cancer (including serous, endometrioid,
                mucinous, clear cell, undifferentiated, or unknown subtype),
                endometrial cancer
              </span>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ●
              <span>
                You used a hair relaxer product continuously for at least four
            ...
            <li className="flex gap-3">
              ●
              <span>
                During your highest use period, you used the product at least
                four times per year.
              </span>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ●
              <span>
                You know the brand you used, and it contained formaldehyde or
                phthalates.
              </span>
            </li>
            <li className="flex gap-3">
              ●
              <span>
                For wrongful-death claims, the statute of limitations must not
                be within 90 days of expiring.
              </span>
            </li>
            <li className="flex gap-3">
              ●
              <span>
                <strong>Accepted hair relaxer brands include: </strong>
                Africa’s Best, Ultra Precise, Bantu, TCB Naturals, Dark &
                Lovely, Luster’s, Just For Me, Mizani Relaxer, Motions, Optimum,
                Organic Root Stimulator (ORS Olive Oil – when mixed with a
                relaxer), Soft & Beautiful, and African Pride.
              </span>
            </li>
            <li className="flex gap-3">
              ●
              <span>
                If another brand was used, you must know the exact product name
                and confirm that it contained formaldehyde or phthalates.
              </span>
            </li>
          </div>
...
md:leading-[28px]
  "
          >
            ...
            quick, confidential form to see if you qualify for a hair relaxer
...
export default HairRelaxerLawsuitB;
