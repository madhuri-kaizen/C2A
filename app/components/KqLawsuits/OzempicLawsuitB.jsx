...
const ozempicInjection = "/Form/ozempicinjection.png";
const womanCry = "/Form/womancry.png";
...
const OzempicLawsuitB = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "26297818809908394"; //last one : 1409965080153428
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/ozempic-lawsuit-b-kq",
      vertical: LEAD_GENERATION_VERTICALS.OZEMPIC,
      formname: "Ozempic Lawsuit lander B KQ",
...
py-20
  ...
  "
>
                   Ozempic Lawsuit: <span className="text-[#F8D216]">Find If</span> 
                  <br />
                   <span className="text-[#F8D216]">You Qualify</span> for Legal
                  <br />
                   Compensation for Ozempic
                   <br />
                   Side Effects Today
                </h1>

                <p className="text-[13.5px] text-gray-300 mb-4 leading-relaxed tracking-wide">
                  Have you or a loved one suffered serious side effects after using Ozempic? 
                  You’re not alone, and you may be entitled to compensation. Many patients 
                  have reported complications like severe eye injuries, such as Non-Arteritic 
                  Anterior Ischemic Optic Neuropathy (NAION), after taking Ozempic. 
                  <br />
                  <br />
                  <span className="font-bold">At  Connect 2 Attorney, we help you:</span>
                  <br />
                  <br />
                  ✅ Understand your legal rights and options if you are harmed by Ozempic. <br />
                  ✅ Get a free, confidential case review to see if you qualify for a lawsuit. <br />
                  ✅ Connect with experienced Ozempic lawsuit attorneys who fight for maximum compensation. <br />
                  ✅ Seek recovery for medical bills, lost wages, and pain and suffering caused by Ozempic side effects. <br /> <br />
                </p>
...
leading-tight font-semibold text-[#162766] mb-4">
                    About Ozempic and the Ozempic Lawsuit
                </h2>
...
">
                    Ozempic is a brand-name GLP-1 medication containing semaglutide, commonly prescribed 
                    for type 2 diabetes and sometimes for weight loss. Lawsuits now allege possible 
                    links between Ozempic and serious side effects, especially severe eye injuries 
                    such as Non-Arteritic Anterior Ischemic Optic Neuropathy (NAION), which can cause 
...
">
                    An Ozempic lawsuit claims patients were not adequately warned about these risks. 
                     Connect 2 Attorney helps affected individuals check eligibility and connect with 
...
">
                    Ozempic Lawsuit Eligibility for Vision and Intestinal Injury Claims
                </h2>
...
">
                    To qualify for compensation through an Ozempic lawsuit, all the following requirements must be met: 
                </p>
...
">
                    <li className="flex gap-3">
                        ●
                    <span>
                     Must have been diagnosed with Non-Arteritic Anterior Ischemic Optic Neuropathy (NAION) caused by Ozempic or another GLP-1 drug. 
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        The injury must have occurred while actively taking the medication.  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        You must have stopped the drug at the time of diagnosis.  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        You must have lasting harm, such as permanent vision impairment.  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        You must have been 75 years old or younger at the time of use.   
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        You must have used a brand-name GLP-1 medication only: Ozempic, Wegovy, Rybelsus, Trulicity, Mounjaro, or Zepbound.    
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        You must have a valid U.S. Social Security number (confirmation only).   
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        Your claim must fall within the applicable statute of limitations based on your state and diagnosis date.   
                    </span>
                    </li>
                </ul>
...
font-lato
    ...
    xl:text-[17px]">
                    ...
                    quick, confidential form to see if you qualify for an Ozempic
...
leading-relaxed
 text-[#162766] mb-2">
  ...
  "
>
                    Get matched with experienced Ozempic lawyers.
                    </p>
                </div>
...
">
            Ozempic Lawsuit: <span className="text-[#F8D216]">Find If You</span>
            <br />
            <span className="text-[#F8D216]">Qualify</span> for Legal Compensation
            <br />
            for Ozempic Side Effects Today
          </h1>
...
">
            Have you or a loved one suffered serious side effects after using Ozempic? You’re not alone, and you may be entitled to compensation. Many patients have reported complications like severe eye injuries, such as Non-Arteritic Anterior Ischemic Optic Neuropathy (NAION), after taking Ozempic.  
          </p>
...
<p
  ...
  "
>
            Ozempic is a brand-name GLP-1 medication containing semaglutide, commonly prescribed for type 2 diabetes and sometimes for weight loss. Lawsuits now allege possible links between Ozempic and serious side effects, especially severe eye injuries such as Non-Arteritic Anterior Ischemic Optic Neuropathy (NAION), which can cause sudden and permanent vision loss.
          </p>
...
<p
  ...
  "
>
            An Ozempic lawsuit claims patients were not adequately warned about these risks.  Connect 2 Attorney helps affected individuals check eligibility and connect with qualified attorneys to pursue compensation for medical costs and long-term complications. 
          </p>
...
>
            ...
            confidential form to see if you qualify for an Ozempic lawsuit. Our
...
export default OzempicLawsuitB;
