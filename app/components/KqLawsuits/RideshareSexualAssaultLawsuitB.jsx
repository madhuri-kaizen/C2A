...
const lawyerReadingS = "/Form/lawyerreadingsmall.png";
const rideshareSa = "/Form/ridesharesa.png";
...
const RideshareSexualAssaultLawsuitB = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = ""; //last one : 1409965080153428
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/rideshare-sa-lawsuit-b-kq",
      vertical: LEAD_GENERATION_VERTICALS.RIDESHARE,
      formname: "Rideshare Sexual Assault Lawsuit Form B KQ",
...
formname: "Rideshare Sexual Assault Lawsuit Form B KQ",
  ...
  //         websiteName: '  Connect 2 Attorney',
  //         vertical: LEAD_GENERATION_VERTICALS.RIDESHARE,
  //         formPath: '/rideshare-sa-lawsuit-b',
  //         formname: 'Rideshare Sexual Assault Lawsuit Form B',
  //         data: {
...
>
                  ...
                  <br />
                   <span className="text-[#F8D216]">Check If You Qualify</span> for a Free,
                  <br />
                  Confidential Case Review
                </h1>

                <p className="text-[13.5px] text-gray-300 mb-4 leading-relaxed tracking-wide">
                  If you’re a male or female passenger harmed by sexual assault by a rideshare driver, you may have options through the Uber sexual assault lawsuit or a related Lyft sexual assault lawsuit.  Connect2Attorney screens cases privately and, if eligible, connects you with an Uber assault lawyer / Lyft assault lawyer.
                  <br />
                  <br />
                  <span className="font-bold">Why choose  Connect2Attorney for your rideshare sexual assault lawsuit?</span>
                  <br />
                  <br />
                  ✅ Fast, confidential intake (no pressure) <br />
                  ✅ Criteria-based screening for qualified rideshare sexual assault lawsuit claims <br />
                  ✅ Ride receipt required (or willingness to obtain it) <br />
                  ✅ Clear guidance on MDL 3084 updates (Uber litigation) and bellwether trial meaning <br /> <br />
                </p>
...
leading-tight font-semibold text-[#162766] mb-4">
                    Understanding the Uber Sexual Assault Lawsuit & Your Legal Options
...
">
                    The Uber sexual assault lawsuit and related rideshare sexual assault lawsuit filings focus on whether platforms did enough to prevent foreseeable harm. Many survivors don’t realize a claim can depend on where/when the assault happened, whether there was physical contact, and whether key proof, like the ride receipt, can be provided.
                </p>
...
">
                    If your incident occurred in the vehicle, just outside it, or was contemporaneous with the ride, and you’re able to document the ride and reporting steps, you may be eligible to pursue compensation for rideshare assault. We can also explain what MDL 3084 updates (Uber litigation) and bellwether trial meaning may signal for timing and settlement pressure. 
                </p>
...
">
                    Sexual Assault Lawsuit Eligibility Requirements
                </h2>
...
">
                    To qualify through  Connect2Attorney, your claim must meet all of the following:
                </p>
...
">
                    <li className="flex gap-3">
                        ●
                    <span>
                     <strong>Passenger claim only:</strong> Assault by an Uber or Lyft driver (male or female survivors)
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        Physical contact required (Tier 1–3 only; no attempt-only cases)  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>Ride-linked location/timing:</strong> In the car, just outside, or part of an assault that began in/around the ride and was contemporaneous   
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>Ride receipt:</strong>Must provide it or confirm you'll obtain it for the law firm
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>Reporting/evidence:</strong> Reported to Uber/Lyft, police, medical/therapist, or friend/family (same time period) and/or can provide audio/video when available     
                    </span>
                    </li>
...
font-lato
    ...
    xl:text-[17px]">
                    ...
                    quick, confidential form to see if you qualify for a rideshare sexual assault
...
leading-relaxed
 text-[#162766] mb-2">
  ...
  "
>
                    Get matched with experienced rideshare sexual assault lawyers.
                    </p>
                </div>
...
>
    ...
    leading-[48px]
">
              Ready To Get a Free Rideshare Sexual <br />
              Assault Lawsuit Review?
            </h2>
...
">Email</label>
 ...
 Q2. </span>   What best describes what happened?
              ...
              >
                <option value="">Please select an option</option>
                <option value="Forced Sexual act">Forced sexual act (forced oral, forced manual stimulation)</option>
                <option value="Non-consensual touching">Non-consensual sexual touching or kissing of a sexual body part</option>
                <option value="Indecent exposure">Indecent exposure / masturbation</option>
                <option value="Kidnapping">Kidnapping / false imprisonment with overt sexual or extreme physical threats</option>
                <option value="Other">Other</option>
...
>
            ...
            confidential form to see if you qualify for a rideshare sexual assault lawsuit. Our
...
export default RideshareSexualAssaultLawsuitB;
