...
import { DepoProveraLawsuitSendAdminEmail, DepoProveraLawsuitSendUserEmail } from '../emailService2';
import {
...
const DepoProveraLawsuitD = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "939384558797518"; //1409965080153428 input pixel id 
...
const createEarlyLead = async ({ fullName, phone, email = "" }) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/depo-provera-lawsuit-d-kq",
      vertical: LEAD_GENERATION_VERTICALS.DEPO_PROVERA,
      formname: "Depo-Provera Lawsuit Lander D KQ",
            ...
            <div className="pt-0 mt-20 text-white flex justify-center">
              <div className=" max-w-[720px]">
                 <h1 className="text-[32px] sm:text-[34px] md:text-[38px] lg:text-[42px] xl:text-[46px] leading-snug font-semibold mb-4">
                  Depo-Provera Lawsuit <br /> for Meningioma: Check If You <br /> Qualify for     <span className="bg-[#162766] text-[#F8D216] px-3 py-[3px] rounded-md inline-block">
                       Compensation
                    </span>
                ...
                <p className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed tracking-wide text-white mb-4">
                  Depo-Provera and Depo-SubQ Provera users across the U.S. are filing claims after a meningioma (brain tumor) diagnosis. Deadlines may apply by state; check eligibility in under a minute. 
                </p>
                 ...
                 <ul className="mt-6 space-y-4 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] xl:text-[19px] text-white">
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                        Meningioma diagnosis after <span className="font-semibold">Depo use may qualify</span> 
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                        <span className="font-semibold">2+</span> injections (Depo-Provera or Depo-SubQ)
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                        Time limits vary by state, <span className="font-semibold">don’t wait to check</span>
                        </span>
                    </li>
                </ul>
              </div>
...
lg:text-[16px]
 ${
                  ...
                  {[
  { q: "Q1. Have you been diagnosed with meningioma?", name: "q1" },
  {
...
">
                ...
                If you meet the criteria, your lawsuit may seek compensation for the real-life
                costs of a meningioma diagnosis, especially when it impacts work, health, and
                daily life. Every case is different, but qualified claims <br /> <span className="font-semibold">commonly include:</span> 
                </p>
                ...
                <li className="flex items-start gap-2">
                    ...
                    Medical expenses (imaging, neurology visits, treatment, follow-ups)
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Surgery-related costs (hospital bills, recovery, rehabilitation)
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Lost income if symptoms or treatment forced time off work
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                ...
                Depo-Provera Meningioma Claims<br />
                Focus on What Patients Were Told
                </h3>
                ...
                <p>
                    Many patients say they used Depo-Provera for years without being clearly
                    warned about a potential connection to meningioma (a type of brain tumor).
                </p>

                <p>
                    Legal reviews look closely at sequence and timing: your meningioma diagnosis
                    must have occurred after Depo-Provera or Depo-SubQ Provera use.
                </p>

                <p>
                    Eligibility also depends on dosage history: you must have received at least
                    two injections, and your diagnosis must be 2+ years after your first shot.
                </p>

                <p>
                    Because filing windows vary by state (and some states are excluded), a quick
                    confidential screening can confirm whether you’re eligible to file before
                    time runs out.
                </p>
                </div>
                ...
                {/* ===== SECTION 3 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                Meningioma Symptoms That Often Lead to Diagnosis
                </h3>

                <p className="text-[16px] text-[#5A627A] mb-4">
                Common symptoms that lead to diagnosis may include:
                </p>
 ...
 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
      ...
      <div className=" lg:hidden w-full bg-[#162766]">
            <div className=" max-w-[720px] px-4 py-10 text-white font-jakarta">
                ...
                Depo-Provera and Depo-SubQ Provera users across the U.S. are filing
                claims after a meningioma (brain tumor) diagnosis. Deadlines may
                apply by state; check eligibility in under a minute.
                </p>

                <ul className="space-y-7 font-bold text-[14px]">
                <li className="flex items-start gap-3">
              <span className=" text-[#F8D216] text-[14px] leading-none">➜</span>
 
                    <span>
                    Meningioma diagnosis after Depo use may qualify
                    </span>
                </li>
      ...
      <section className=" lg:hidden w-full bg-white py-10">
            <div className="px-4 font-jakarta text-[#162766]">
                ...
                If you meet the criteria, your lawsuit may seek compensation for the
                real-life costs of a meningioma diagnosis, especially when it impacts
                work, health, and daily life. Every case is different, but qualified
                claims <br /> <span className="font-bold">commonly include:</span> 
                </p>
                ...
                Depo-Provera Meningioma Claims Focus on What <br />Patients Were Told
                </h3>
                ...
                <p>
                    Many patients say they used Depo-Provera for years without being
                    clearly warned about a potential connection to meningioma
                    (a type of brain tumor).
                </p>

                <p>
                    Legal reviews look closely at sequence and timing: your meningioma
                    diagnosis must have occurred after Depo-Provera or Depo-SubQ
                    Provera use.
                </p>

                <p>
                    Eligibility also depends on dosage history: you must have received
                    at least two injections, and your diagnosis must be 2+ years after
                    your first shot.
                </p>

                <p>
                    Because filing windows vary by state (and some states are excluded),
                    a quick confidential screening can confirm whether you’re eligible
                    to file before time runs out.
                </p>
                </div>
                ...
                <p className="text-[16px] text-[#5A627A] mb-3 font-jakarta">
                Common symptoms that lead to diagnosis may include:
                </p>
...
export default DepoProveraLawsuitD;