...
/**
 * OzempicLawsuit Component with Full Backend Integration
 * 
...
const SocialMediaAddictionLawsuit = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1869281040448661"; //last one : 1409965080153428
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/social-media-addiction-lawsuit-a-kq",
      vertical:LEAD_GENERATION_VERTICALS.SOCIAL_MEDIA_ADDICTION,
      formname: "Social Media Addiction Lawsuit Form A KQ",
  ...
  //         websiteName: '  Connect 2 Attorney',
  //         vertical: LEAD_GENERATION_VERTICALS.SOCIAL_MEDIA_ADDICTION,
  //         formPath: '/social-media-addiction-lawsuit-a',
  //         formname: 'Social Media Addiction Lawsuit Form',
  //         data: {
...
py-20
  ...
  font-lato
    ...
    mb-4">
                  ...
                  <br />
                  Lawsuit: See If Your Child's
                  <br />
                  Harmed Meets the Legal
                  <br />
                  Criteria
                </h1>
...
">
                  If your child started using social media before age 18, spent 3+ 
                  hours a day across platforms, and later suffered serious harm, you 
                  may have legal options through a social media addiction lawsuit. 
                   Connect2Attorney helps parents and legal guardians check 
                  eligibility privately and connect with a social media addiction lawsuit
                  attorney if the case qualifies. 
                </p>
...
">
                  Get a free, confidential case review; built for parents, not paperwork.
                </p>
              </div>
            </div>
...
bg-[#F8D216]
    ...
    rounded-lg ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
        ...
        {/* Rest of the desktop content remains the same... */}
        {/* (Continuing with all sections: What Happens, Testimonials, Why Trust, Footer) */}
...
">
    ...
    mx-auto
">
              When you reach out to  Connect2Attorney for a social media <br />addiction lawsuit review, the
...
">
    ...
    max-w-[260px]
    mx-auto">
                  Tell us your child’s age, when use began, daily hours, platforms used, and what changed after 2012. No long forms.
                </p>
              </div>
...
">
    ...
    max-w-[260px]
    mx-auto">
                  We check the legal criteria: age window, minor-use timeline, 3+ hours/day, documented harm, and treatment, plus whether filing deadlines still apply.  
                </p>
              </div>
  ...
  ">
            ...
            <div className="relative">
              ...
              >
                {[
                  {
                    text: " I didn’t know what mattered legally, usernames, dates, the first contact, and how it escalated. They helped me organize everything without overwhelming us.",
                    name: "Amanda Roger",
                  },
                  {
                    text: " They were clear about what not to send and how to document safely. That alone made me feel protected.",
                    name: "Jason L.",
                  },
                  {
                    text: "We felt powerless. The review was respectful, private, and focused on action, not judgment.",
                    name: "Samuel Walt",
                  },
                ].map((item, idx) => (
                  <div
...
">Parent</p>
 ...
 ">
    ...
    mb-3
">
                 Connect2Attorney supports families exploring a social media addiction 
                lawsuit by matching eligible cases with attorneys who understand youth harm, 
                platform accountability, and complex digital evidence, especially in matters 
                involving Meta and Instagram. 
              </p>
...
">
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on social media addiction claims.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    If you’re trying to find the best social media addiction lawyer, 
    ...
    leading-[48px]
">
              Ready To Get a Free Social Media <br /> 
              Addiction Lawsuit Review?
            </h2>
...
">
    ...
    mb-6
">
            If your child started using social media before 
            age 18, spent 3+ hours a day across platforms, and 
            later suffered serious harm, you may have legal options 
            through a social media addiction lawsuit.  Connect2Attorney 
            helps parents and legal guardians check eligibility privately 
            and connect with a social media addiction lawsuit attorney if the case qualifies. 
          </p>
...
>
            ...
            Get af free, confidential case review; <br />
            built for parents and guardians.
          </p>
        </div>
      </div>
...
">Email</label>
            ...
            {[
              ...
              "Q3. Did the individual experience serious harm such as suicidal thoughts, self-harm, eating disorders, substance abuse, or exploitation after using social media?",
            ].map((q, i) => (
              <div key={i}>
                <p className="  font-lato
    text-[#191B37]
...
<p
  className="
    ...
    mb-10
  "
>            When you reach out to  Connect2Attorney for a social media addiction lawsuit review, the
            process is simple and fast:
          </p>
...
<p
  ...
  "
>
               “I felt stuck between fear and confusion. They helped me understand what details mattered: age, hours of use, treatment and what the next step actually looks like.”
            </p>
...
<p
  ...
  "
>
               “I didn’t want to label my child. I just needed help. The process was respectful, private, and clear.”
            </p>
...
<p
  ...
  "
>
              “We kept seeing headlines and social media addiction lawsuit news today but didn’t know what was real. They helped us focus on eligibility, not hype.”
            </p>
...
<p
  className="
    ...
    mb-5
  "
>             Connect2Attorney supports families exploring a social media 
            addiction lawsuit by matching eligible cases with attorneys who 
            understand youth harm, platform accountability, and complex 
            digital evidence, especially in matters involving Meta and Instagram. 
          </p>
...
>            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                If you’re trying to find the best social media addiction lawyer, we help match 
...
<h2
  ...
  "
>
            Ready To Get a Free Social <br />
            Media Addiction Lawsuit Review?
          </h2>
...
export default SocialMediaAddictionLawsuit;
