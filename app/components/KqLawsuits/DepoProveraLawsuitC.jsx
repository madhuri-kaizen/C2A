...
import {
  DepoProveraLawsuitSendAdminEmail,
  DepoProveraLawsuitSendUserEmail,
} from "../emailService2";
import {
...
const DepoProveraLawsuitC = () => {
  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/depo-provera-lawsuit-c-kq",
        vertical: LEAD_GENERATION_VERTICALS.DEPO_PROVERA,
        formname: "Depo-Provera Lawsuit Lander C KQ",
  ...
  //       Promise.all([
  //         DepoProveraLawsuitSendAdminEmail({ formData: payload }),
  //         DepoProveraLawsuitSendUserEmail({ formData: payload })
  //       ]).catch(err => {
...
py-20
  ...
  "
                >
                  {" "}
                  <span className="font-normal">Depo-Provera Lawsuit:</span>
                  <br />
                  <span className="font-semibold">
                    See If You Qualify in <br /> 30 Seconds
                  </span>
                </h1>
  ...
  "
                >
                  If you were diagnosed with a meningioma (brain tumor) after
                  using the Depo shot birth control injection, you may be
                  eligible for compensation. Faster action matters; deadlines
                  can apply.
                </p>
              </div>
            </div>
            ...
            {/* ===== RIGHT FORM ===== */}
            <div className="pt-10 flex justify-center pr-4">
 ...
 ${
   desktopTouched.email && desktopErrors.email
     ...
     : "border-[#D7DBEA]"
                    ...
                    {[
                      {
                        q: "Q1. Have you been diagnosed with meningioma?",
                        name: "q1",
                      },
                      {
                        q: "Q2. Have you ever used Depo-Provera or Depo-SubQ Provera?",
                        name: "q2",
                      },
                      {
...
bg-[#F8D216]
            ...
            <div className="grid grid-cols-2 h-full items-center">
              ...
              <div className="max-w-[640px] text-[#162766] pb-10">
                <h2 className="text-[#162766] font-lato text-[40px] font-normal leading-[57.6px] mb-4">
                  ...
                  <span className="font-bold">Meningioma?</span>
                </h2>
                <div className="pr-10">
                  <p className="text-[#162766] font-lato text-[24px] font-medium leading-[36px] mb-4 max-w-[640px]">
                    Depo-Provera, often called the Depo shot, is a prescription
                    birth control injection used by millions of women. But
                    lawsuits allege that long-term Depo-Provera use may be
                    linked to an increased risk of meningioma, a typically
                    slow-growing tumor that can press on the brain and trigger
                    serious complications.
                  </p>

                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-4 max-w-[420px]">
                    If you’ve faced symptoms like persistent headaches, vision
                    changes, seizures, memory issues, or needed brain surgery,
            ...
            <div className="max-w-[1400px] mx-auto px-10">
              <div className="grid grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] overflow-hidden">
                  <div className="bg-[#162766] px-6 py-8 min-h-[130px] flex items-center justify-between">
                    <h3 className="font-lato text-[#FFF] text-[24px] font-bold leading-[36px]">
                      The Symptoms <br /> Aren’t Small
                    </h3>
                    <img
                      src={symptomsarentsmall}
                      alt=""
                      className="w-12 h-12"
                    />
                  </div>
                  ...
                  <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                    Many women report persistent headaches, vision changes,
                    dizziness, seizures, or memory issues before learning they
                    had a meningioma. If this happened after Depo-Provera use,
                ...
                <div className="bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] overflow-hidden">
                  <div className="bg-[#162766] px-6 py-8 min-h-[130px] flex items-center justify-between">
                    <h3 className="font-lato text-[#FFF] text-[24px] font-bold leading-[36px]">
                      Treatment Can <br /> Change Your Life
                    </h3>
                    <img src={dollarbag} alt="" className="w-12 h-12" />
                  </div>

                  <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                    A meningioma diagnosis can lead to MRIs, neurological care,
                    medications, time off work, and in some cases, brain surgery
                    or radiation, all with long-term impacts on daily life.
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] overflow-hidden">
                  <div className="bg-[#1B2B6B] px-6 py-8 min-h-[130px] flex items-center justify-between">
                    <h3 className="font-lato text-[#FFF] text-[24px] font-bold leading-[36px]">
                      Your Time to <br /> File May Be Limited
                    </h3>
                    <img
                      src={symptomsarentsmall}
                      alt=""
                  ...
                  <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                    Depo-Provera claims can be affected by state filing
                    deadlines. Waiting too long may reduce your legal options—so
                    it’s smart to check eligibility sooner, not later.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-20 items-center">
              ...
              <div className="text-[#162766]">
                <h2 className="font-lato text-[#162766] text-[24px] font-bold leading-[36px] mb-5">
                  Growing Attention Around Depo-Provera & Meningioma
                </h2>

                <ul className="space-y-4 font-lato text-[#162766] text-[16px] font-normal leading-[24px] list-disc pl-5  max-w-[720px]">
                  {" "}
                  <li>
                    Depo-Provera is a widely used progestin-based birth control
                    injection (DMPA).
                  </li>
                  <li>
                    Lawsuits allege failure to warn about potential brain tumor
                    risks tied to long-term exposure.
                  </li>
                  <li>
                    Meningiomas can require surgery, radiation, and long-term
                    monitoring, impacting work and daily life.
                  </li>
                  <li>
                    Women are increasingly seeking legal reviews after
                    meningioma diagnoses following Depo shot use.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 h-full items-center">
              ...
              <div className="max-w-[640px] text-[#1B2B6B] pb-10">
                <h2 className="font-lato text-[#162766] text-[40px] font-normal leading-normal mb-4">
                  You deserve a legal team that takes your{" "}
                  <span className="font-semibold">
                    Depo diagnosis seriously.
                  </span>
                </h2>
                <div className="pr-10">
                  <p className="font-lato text-[#162766] text-[18px] font-medium leading-normal mb-4 max-w-[500px]">
                    ...
                    alone.  Connect 2 Attorney helps you take action by connecting you
                  ...
                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    ...
                    <span className="font-normal">
                      Meningioma diagnosis can bring major costs such as MRIs,
                      specialist visits, surgery, medication, time off work, and
                      long-term monitoring. If Depo-Provera played a role, you
                  ...
                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    ...
                    Lawsuits allege women were not fully warned about potential
                    risks tied to long-term Depo use. If you were left in the
                    dark, you deserve answers and accountability from the
                  ...
                  <p className="text-[16px] font-lato leading-[1.7] text-[#162766]">
                    <span className="font-semibold">NO COST TO START</span> Most
                    Depo-Provera cases are handled on a contingency basis,
                    meaning no upfront fees, and you typically don’t pay unless
                    your case results in compensation.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-24 items-center">
              ...
              <div className="text-white text-center flex flex-col items-center">
                <h2 className="font-lato text-[#F8F9FA] text-[40px] font-bold leading-normal text-center mb-6">
                  <span className="font-semibold">Depo-Provera</span> claims are
                  being reviewed{" "}
                ...
                <p className="font-lato text-[#F8F9FA] text-[24px] font-normal leading-[36px] text-center  ">
                  Meningioma + long-term Depo shot use?
                  <br />
              ...
              {/* RIGHT CONTENT */}
              <div className="font-lato text-[#F8F9FA] text-[20px] font-bold leading-[30px] text-left mx-auto max-w-[480px]">
                Lawsuits involving Depo-Provera allege that women were not
                adequately warned about a potential increased risk of meningioma
                brain tumors with extended use. If you’ve been diagnosed,
                especially if you require surgery or ongoing treatment, getting
                a case review can help you understand whether you may qualify
                for compensation.
              </div>
            </div>
          </div>
  ...
  <div className="max-w-[600px] ml-auto mr-10">              
      <h2 className="font-lato text-[#162766] text-[40px] font-bold leading-[57.6px] mb-4">
                  <span className="font-semibold">We’ll help you</span> take the
                  next step,
                  <br />
                  <span className="font-semibold">without the overwhelm.</span>
                </h2>

                <p className=" font-lato text-[#162766] text-[24px] font-medium leading-[28.8px] mb-6  ">
                  If you used Depo-Provera and were diagnosed with a meningioma,
                  you may be dealing with medical decisions, stress, and
                  uncertainty. A case review can clarify whether your timeline
                  and diagnosis may qualify.
                </p>
  ...
  transition-colors duration-300
                  ...
                  >
                    <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] bg-white">
                      Many Depo-Provera attorneys work on contingency. That
                      means you typically pay nothing upfront, and attorney fees
                      are only collected if your case results in compensation.
                    </div>
                  </div>
 ...
 border-t border-[#E2E6F3]
                  ...
                  >
                    <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] text-[#3E4A6B] bg-white">
                      Your eligibility often depends on proof of Depo-Provera
                      use, diagnosis type (like intracranial meningioma),
                      treatment history, and timing. Legal teams can help
 ...
 border-t border-[#E2E6F3]
                  ...
                  >
                    <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] text-[#3E4A6B] bg-white">
                      You’ll get a straightforward explanation of the next
                      steps, such as what matters, what doesn’t, and whether
                      pursuing a claim makes sense for your situation.
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* RIGHT (LAVENDER) */}
<div className="bg-[#EBEEFF] px-10 py-16 flex items-center  ">              
  ...
  "
>
                  We focus on helping people understand whether they may qualify
  ...
  "
>
                  You can complete a simple screening by answering a few quick
                  questions about your Depo shot use and diagnosis, and your
                  information will be reviewed confidentially. If you may
                  qualify, you will receive clear guidance on the next steps,
                  and there is no pressure; you decide how you would like to
                  proceed.
                </p>
...
>
                  <br />
                  If you’ve been diagnosed with a meningioma after Depo-Provera
                  use, you deserve to know your options.
                </p>
              </div>
            </div>
          </div>
...
"
            >
              Ready To Get a Free Depo-Provera Case Review?
            </h2>
...
"
  ...
  "
          >
            If you were diagnosed with a meningioma (brain tumor) after using
            the Depo shot birth control injection, you may be eligible for
            compensation. Faster action matters; deadlines can apply.
          </p>
        </div>
      </div>

      {/* ===== MOBILE FORM ===== */}
      <div className=" lg:hidden bg-white   -mt-6 pt-8 pb-10">
...
"
            ...
            {[
              "Have you been diagnosed with meningioma?",
              "Have you ever used Depo-Provera or Depo-SubQ Provera?",
 ...
 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
  ...
  "
          >
            Were You Diagnosed
            <br />
            with <span className="font-bold">Meningioma?</span>
          </h2>
  ...
  "
          >
            Depo-Provera, often called the Depo shot, is a prescription birth
            control injection used by millions of women. But lawsuits allege
            that long-term Depo-Provera use may be linked to an increased risk
            of meningioma, a typically slow-growing tumor that can press on the
            brain and trigger serious complications.
          </p>
  ...
  "
          >
            ...
            seizures, memory issues, or needed brain surgery, you deserve
  ...
  "
            ...
            <div className="px-5 py-7  text-[16px] font-lato leading-[1.65] font-medium text-[#162766]/80">
              Many women report persistent headaches, vision changes, dizziness,
              seizures, or memory issues before learning they had a meningioma.
              If this happened after Depo-Provera use, you deserve real answers.
            </div>
          </div>
  ...
  "
            >
              A meningioma diagnosis can lead to MRIs, neurological care,
              medications, time off work, and in some cases, brain surgery or
              radiation — all with long-term impacts on daily life.
            </div>
          </div>
  ...
  "
            ...
            <div className="px-5 py-7 text-[16px] font-roboto leading-[1.65] font-medium text-[#162766]/80">
              Depo-Provera claims can be affected by state filing deadlines.
              Waiting too long may reduce your legal options — so it’s smart to
              check eligibility sooner, not later.
            </div>
          </div>
        </div>
      </section>
  ...
  "
        ...
        <div className="flex justify-center">
          <ul className="space-y-4 font-lato text-[#162766] text-[16px] font-normal leading-[24px] list-disc pl-5  max-w-[720px]">
            ...
            <li>
              Lawsuits allege failure to warn about potential brain tumor risks
            ...
            <li>
              Women are increasingly seeking legal reviews after meningioma
              diagnoses following Depo shot use.
            </li>
          </ul>
        </div>
  ...
  "
          >
            You deserve a legal <br /> team that takes your <br />
            <span className="font-semibold">Depo diagnosis seriously.</span>
          </h2>
  ...
  "
          >
            ...
            diagnosis, you shouldn’t have to navigate this alone.  Connect 2 Attorney
          ...
          <p className="text-[16px] font-lato leading-[22px] mb-8">
            ...
            Meningioma diagnosis can bring major costs such as MRIs, specialist
            visits, surgery, medication, time off work, and long-term
            monitoring. If Depo-Provera played a role, you may be able to seek
            compensation.
          </p>

          <p className="text-[16px] font-lato leading-[22px] mb-4">
            <span className="font-semibold">ACCOUNTABILITY</span> Lawsuits
            allege women were not fully warned about potential risks tied to
            long-term Depo use. If you were left in the dark, you deserve
            answers.
          </p>

          <p className="text-[16px] font-lato leading-[22px] mb-4">
            <span className="font-semibold">SUPPORT &amp; GUIDANCE</span> From
            your first eligibility check through next steps, you’ll receive
            clear direction without confusing legal jargon.
          </p>

          <p className="text-[16px] font-lato leading-[22px] mb-4">
            <span className="font-semibold">NO COST TO START</span> Most cases
            are handled on a contingency basis — no upfront fees, and you only
            pay if your case results in compensation.
          </p>
        </div>
        ...
        {/* ===== BOTTOM YELLOW LINE qualify today before===== */}
        <div className="w-full h-[6px] bg-[#F8D216]" />
      </section>
      ...
      <section className=" lg:hidden w-full bg-[#162766] px-5 py-14 text-center">
        ...
        <h2 className="text-[28px] font-lato leading-[32px] font-semibold text-white mb-4">
          Depo-Provera claims are <br /> being reviewed nationwide
        </h2>
        ...
        <p className="text-[18px] font-lato leading-[24px] text-white mb-10">
          Meningioma + long-term Depo
          <br />
          shot use? You may have legal
          <br />
        ...
        <p className="text-[16px] font-lato leading-[26px] text-white max-w-[320px] mx-auto">
          Lawsuits involving Depo-Provera allege that women were not adequately
          warned about a potential increased risk of meningioma brain tumors
          with extended use. If you’ve been diagnosed, especially if you require
          surgery or ongoing treatment, getting a case review can help you
          understand whether you may qualify for compensation.
        </p>
      </section>
      ...
      <section className=" lg:hidden relative w-full bg-white px-5 pt-10 pb-20 overflow-hidden">
        ...
        <h2 className="text-[30px] font-lato leading-tight font-normal text-[#162766] mb-4">
          <span className="font-semibold">We’ll help you</span> <br /> take the
          next step,
          <br />
          <span className="font-semibold">without the overwhelm.</span>
        </h2>
        ...
        <p className="text-[16px] font-lato font-normal leading-[22px] text-[#162766] mt-8 mb-4">
          If you used Depo-Provera and were diagnosed with a meningioma, you may
          be dealing with medical decisions, stress, and uncertainty. A case
          review can clarify whether your timeline and diagnosis may qualify.
        </p>
...
"
        >
          But <span className="underline underline-offset-4">don’t waitz</span>,
          <br />
          <span className="font-normal">
            {" "}
            see if you qualify today before it’s too late.
          </span>
        </p>
        ...
        <div className="border border-[#E2E6F3] rounded-lg overflow-hidden ">
          ...
          >
            No Win, No Fees
            <span
              className={`transition-transform ${faqOpen.fee ? "rotate-180" : ""}`}
            >
              ▾
            </span>
          </button>
          ...
          >
            <div className="px-4 py-3 text-[16px] font-lato leading-[21px] text-[#162766] bg-white">
              Many Depo-Provera attorneys work on contingency. That means you
              typically pay nothing upfront, and attorney fees are only
              collected if your case results in compensation.
            </div>
          </div>
          ...
          >
            Medical Record Review
            <span
              className={`transition-transform ${faqOpen.records ? "rotate-180" : ""}`}
            >
              ▾
            </span>
          </button>
          ...
          >
            <div className="px-4 py-3 text-[16px] font-lato leading-[21px] text-[#162766] bg-white">
              Your eligibility often depends on proof of Depo-Provera use,
              diagnosis type (like intracranial meningioma), treatment history,
              and timing. Legal teams can help identify what documentation is
              needed.
            </div>
          </div>
          ...
          >
            Personal Support
            <span
              className={`transition-transform ${faqOpen.support ? "rotate-180" : ""}`}
            >
              ▾
            </span>
          </button>
          ...
          >
            <div className="px-4 py-3 text-[16px] font-lato leading-[21px] text-[#3E4A6B] bg-white">
              You’ll get a straightforward explanation of the next steps, such
              as what matters, what doesn’t, and whether pursuing a claim makes
        ...
        <div className="bg-[#EBEEFF] px-4 py-6 mb-6 rounded-b-lg text-[#162766]">
          <h3 className="text-[20px] font-lato leading-[26px] font-semibold mb-3">
            We focus on helping people understand whether they may qualify for a
            Depo-Provera lawsuit.
          </h3>
          ...
          <p className="text-[16px] font-lato leading-[22px] mb-4">
            You can complete a simple screening by answering a few quick
            questions about your Depo shot use and diagnosis, and your
            information will be reviewed confidentially. If you may qualify, you
            will receive clear guidance on the next steps, and there is no
            pressure; you decide how you would like to proceed.
          </p>

          <p className="text-[16px] font-lato leading-[22px]">
            If you’ve been diagnosed with a meningioma after Depo-Provera use,
...
export default DepoProveraLawsuitC;
