...
/**
 * HerniaMeshLawsuit Component with Full Backend Integration
 * 
...
const HerniaMeshLawsuit = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1269893407986138"; //last one : 1409965080153428
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/hernia-mesh-lawsuit-a-kq",
      vertical: LEAD_GENERATION_VERTICALS.HERNIA_MESH,
      formname: "Hernia Mesh Lawsuit Form A KQ",
...
py-20
  ...
  font-lato
    ...
    leading-normal
    mb-4">
                  File Your Hernia Mesh
                  <br />
                  Lawsuit Today and Protect
                  <br />
                  Your Rights
                </h1>
...
">
                  Have you suffered complications from a hernia mesh implant? 
                   Connect 2 Attorney makes it easy to connect with experienced 
...
">
                  Start Your Free Case Review Now. No Fees Unless You Win!
                </p>
              </div>
            </div>
 ...
 ${
  ...
  return (
    <div key={name} className="space-y-1">
      ...
      {/* Question Text — Only Q number bold */}
      <p
        className="
          font-lato
          text-[#191B37]
...
">
    ...
    mx-auto
">
              When you reach out to  Connect 2 Attorney for a hernia mesh <br /> lawsuit review, the
...
">
    ...
    max-w-[260px]
    mx-auto">
                  Complete a short, secure form focused on your hernia mesh implant and 
...
">
    ...
    max-w-[260px]
    mx-auto">
                  Your details are carefully evaluated to determine if it meets the criteria for
...
mb-7">
            ...
            <div className="relative">
              ...
              >
                {[
                  {
                    text: "After complications from hernia mesh surgery,  Connect 2 Attorney guided me to an experienced attorney. Their support made the legal process simple and gave me confidence in seeking compensation.",
                    name: "Robert L.",
                  },
                  {
                    text: "I suffered severe pain from defective hernia mesh.  Connect 2 Attorney connected me with a skilled attorney who explained my options and helped me take the first step toward justice.",
                    name: "Angela M.",
                  },
                  {
                    text: " Connect 2 Attorney made my hernia mesh lawsuit process clear and stress-free. Their team connected me with the right attorney and helped me pursue compensation for my medical complications.",
                    name: "David R.",
                  },
                ].map((item, idx) => (
                  <div
...
">
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on hernia mesh complication
                    claims.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    We connect qualified individuals with attorneys in medical device
                    litigation.
                  </span>
                </li>
...
">
            Have you suffered complications from a hernia mesh implant?
             Connect 2 Attorney makes it easy to connect with experienced attorneys 
...
">Email</label>
            ...
            {[
              ...
              "Are you currently working with an attorney regarding this issue?",
            ].map((q, i) => (
              <div key={i}>
                <p className="  font-lato
    text-[#191B37]
...
>
            ...
            What Happens <br /> When You Contact  Connect 2 Attorney?
          </h2>
...
<p
  className="
    ...
    mb-10
  "
>            When you reach out to  Connect 2 Attorney for a hernia mesh lawsuit review, the
            process is simple and fast:
          </p>
...
<p
  ...
  "
>
              Complete a short, secure form focused on your hernia mesh implant
              and complications caused by it.
            </p>
          </div>
...
<p
  ...
  "
>
              Your details are carefully evaluated to determine if it meets the criteria for a
              Hernia Mesh Lawsuit.
            </p>
          </div>
...
<p
  ...
  "
>
              After complications from hernia mesh surgery,  Connect 2 Attorney guided me to an
...
<p
  ...
  "
>
              I suffered severe pain from defective hernia mesh.  Connect 2 Attorney connected me with a 
...
<p
  ...
  "
>
               Connect 2 Attorney made my hernia mesh lawsuit process clear and stress-free. Their team
...
export default HerniaMeshLawsuit;
