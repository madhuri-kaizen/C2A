...
const TalcumPowderLawsuitD = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1258309779095495"; //938309692057838 input pixel id 
...
const createEarlyLead = async ({ fullName, phone, email = "" }) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/talcum-powder-lawsuit-d-kq",
      vertical: LEAD_GENERATION_VERTICALS.TALCUM,
      formname: "Talcum Powder Lawsuit Lander D KQ",
  ...
  //         websiteName: '  Connect 2 Attorney',
  //         vertical: LEAD_GENERATION_VERTICALS.TALCUM,
  //         formPath: '/talcum-powder-lawsuit-d',
  //         formname: 'Talcum Powder Lawsuit lander D',
  //         data: {
  ...
  const sendToRetellCRM = async ({ payload }) => {
    try {
      ...
      const retellPayload = {
        ...
        vertical: LEAD_GENERATION_VERTICALS.TALCUM,
        formPath: '/talcum-powder-lawsuit-d-kq',
        formname: 'Talcum Powder Lawsuit Lander Form D KQ',
        data: {
          submissionDate: new Date().toLocaleString(),
            ...
            <div className="pt-0 mt-20 text-white flex justify-center">
              <div className=" max-w-[720px]">
                 <h1 className="text-[32px] sm:text-[34px] md:text-[38px] lg:text-[42px] xl:text-[46px] leading-snug font-semibold mb-4">
                  Talcum Powder Lawsuit: If You <br /> Have Ovarian Cancer, You May <br /> Qualify for     <span className="bg-[#162766] text-[#F8D216] px-3 py-[3px] rounded-md inline-block">
                       Compensation
                    </span>
                ...
                <p className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed tracking-wide text-white mb-4">
                  If you were diagnosed with ovarian, fallopian tube, or primary peritoneal cancer and used talc in the genital/perineal area, you may be eligible. Strict qualifications apply; check now in under a minute.  
                </p>
                 ...
                 <ul className="mt-6 space-y-4 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] xl:text-[19px] text-white">
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                        Diagnosis must be <span className="font-semibold">ovarian-based (not uterine)</span> 
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                         Diagnosed withtin the last <span className="font-semibold">10 years (2016-present)</span>
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                         <span className="font-semibold">4+ years</span> of adult perineal talc use before diagnosis
                        </span>
                    </li>
                </ul>
              </div>
...
bg-[#F8D216]
    ...
    rounded-lg ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
        ...
        <section className="w-full bg-white py-20 font-jakarta">
  ...
  ">
                ...
                {/* ===== SECTION 1 ===== */}
                <h2 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3 font-jakarta">
                What a Talcum Powder Lawsuit Claim May Cover
                </h2>
                ...
                If you meet the eligibility criteria, a claim may pursue compensation for the 
                financial and personal impact of an ovarian-based cancer diagnosis. While 
                every case is different,   
                <span className="font-semibold"> qualified claims often seek:</span> 
                </p>
                ...
                <li className="flex items-start gap-2">
                    ...
                    Medical costs (treatment, surgery, scans, oncology care) 
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Out-of-pocket expenses (travel, medications, caregiving support) 
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                ...
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Future medical monitoring and ongoing care needs 
                </li>
                </ul>

                {/* ===== SECTION 2 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                Talcum Powder Ovarian Cancer Claims: Eligibility Depends on Diagnosis Type and Timeline 
                </h3>
                ...
                <p>
                    To qualify, the cancer must be found in the ovary (not the uterus) and must be a qualifying ovarian-based diagnosis, fallopian tube cancer, or primary peritoneal carcinoma. 
                </p>

                <p>
                    The diagnosis must be within the last 10 years (2016–present) and you must have used talc in the genital/perineal area for at least 4 years before diagnosis. 
                </p>

                <p>
                    Screening excludes cases if you tested positive for BRCA1/BRCA2, or if you currently live in Michigan or Texas. 
                </p>

                <p>
                    You must also not be represented by another attorney and must be able to confirm a valid U.S. SSN (confirmation only, not collected). 
                </p>
                </div>

                {/* ===== SECTION 3 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                Symptoms That May Lead to an Ovarian Cancer Diagnosis 
                </h3>
        ...
        {/* ===== FOOTER ===== */}
        <section className="w-full bg-[#162B6F] py-10 font-jakarta">
...
/>
        ...
        <div className="px-4 pt-12 pb-16 text-white">
            ...
            Talcum Powder Lawsuit: If You
            <br />
            Have Ovarian Cancer, You May
            <br />
            Qualify for {"  "}{"  "}
 ...
 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
      ...
      <div className=" lg:hidden w-full bg-[#162766]">
            <div className=" max-w-[720px] px-4 py-10 text-white font-jakarta">
                ...
                <li className="flex items-start gap-3">
                    ...
                    <span>
                     Diagnosed within the  <span className="font-semibold">last 10 years (2016–present)</span>
                    </span>
                </li>
      ...
      <section className="lg:hidden w-full bg-white py-10">
            <div className="px-4 font-jakarta text-[#162766]">
                ...
                If you meet the eligibility criteria, a claim may pursue compensation 
                for the financial and personal impact of an ovarian-based cancer 
                diagnosis. While every case is different, <span className="font-bold">qualified claims often seek: </span>  
                </p>
...
export default TalcumPowderLawsuitD;