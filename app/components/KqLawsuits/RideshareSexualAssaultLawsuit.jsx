...
/**
 * TalcumPowderLawsuit Component with Full Backend Integration
 * 
...
const RideshareSexualAssaultLawsuit = () => {
  // Meta Pixel ID
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/rideshare-sa-lawsuit-a-kq",
      vertical: LEAD_GENERATION_VERTICALS.RIDESHARE,
      formname: "Rideshare Sexual Assault Lawsuit Form A KQ",
...
">
                  If you were assaulted during an Uber or Lyft ride, you’re not alone, 
...
">
                  Start a free case review today with no upfront fees!
                </p>
              </div>
            </div>
...
lg:text-[16px]
 ${
                    ...
                    {/* Q1 - Radio (was previously Q2, unchanged markup) */}
...
">
    ...
    max-w-[260px]
    mx-auto">
                  Share the key facts of the ride and incident. We’ll also 
                  confirm you can provide the ride receipt or obtain it for the law firm.
                </p>
              </div>
...
">
    ...
    max-w-[260px]
    mx-auto">
                  We screen for accepted case types, ensure the assault occurred 
                  in/around the ride, and confirm you’re not already represented.  
                </p>
              </div>
...
">
    ...
    max-w-[260px]
    mx-auto">
                  If eligible, you are connected with a qualified attorney to discuss your rights
                  and next steps.
                </p>
              </div>
            </div>
...
mb-7">
            ...
            <div className="relative">
              ...
              >
                {[
                  {
                    text: "They were respectful, fast, and clear about what information mattered, especially the ride details and documentation. That made everything feel less overwhelming.",
                    name: "Jasmine Roger",
                  },
                  {
                    text: "I didn’t want to repeat my story to ten different people. The intake was private, and I felt heard the entire time.",
                    name: "Taylor May",
                  },
                  {
                    text: "I had questions about the process and what attorneys look for in these cases. I finally got real answers without pressure.",
                    name: "Morgan L.",
                  },
                ].map((item, idx) => (
                  <div
...
">
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on rideshare sexual assault claims.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    We guide you only if your case meets the lawsuit requirements, avoiding
                    unnecessary calls or delays.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    If you’re trying to find the best Uber sexual assault lawsuit lawyer, 
                    we help match you based on your situation, not a one-size-fits-all handoff. 
                  </span>
                </li>
...
">
    ...
    mb-6
">
            If you were assaulted during an Uber or Lyft ride, 
...
">Email</label>
            ...
            {/* Q1 - Radio (was previously Q2, markup untouched) */}
            <div>
              <p className="   font-lato
    text-[#191B37]
    text-[15.8px]
...
>
 ...
 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
      ...
      {/* Mobile sections remain the same... */}
{/* ================= MOBILE WHAT HAPPENS ================= */}
...
<p
  ...
  "
>
              Share the key facts of the ride and incident. We’ll also confirm you can 
              provide the ride receipt or obtain it for the law firm.
            </p>
          </div>
  ...
  "
 />
            <h3 className="text-[16px] font-semibold text-[#162766] mb-2">Eligibility Review</h3>
<p
  className="
    font-lato
    text-[#404040]
  ...
  "
>
              We screen for accepted case types, ensure the assault occurred in/around the ride, 
              and confirm you’re not already represented.  
            </p>
          </div>
...
<p
  ...
  "
>
              If eligible, you are connected with a qualified attorney to discuss your rights and
              next steps.
            </p>
          </div>
...
<p
  ...
  "
>
              They were respectful, fast, and clear about what information mattered, especially the ride 
              details and documentation. That made everything feel less overwhelming.
            </p>
...
<p
  ...
  "
>
              I didn’t want to repeat my story to ten different people. The intake was private, 
              and I felt heard the entire time.
            </p>
...
<p
  ...
  "
>
              I had questions about the process and what attorneys look for in these cases. 
              I finally got real answers without pressure.
            </p>
...
>            <li className="flex gap-3">
              ...
              <span>
                We use clear, criteria-based screening focused on talcum powder-caused cancer
                claims.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                We guide you only if your case meets the lawsuit requirements, avoiding unnecessary
                calls or delays.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                We connect qualified individuals with attorneys in product liability
                litigation.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                If you’re trying to find the best Uber sexual assault lawsuit lawyer, we help match 
                you based on your situation, not a one-size-fits-all handoff. 
              </span>
            </li>
...
export default RideshareSexualAssaultLawsuit;
