  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/hair-relaxer-lawsuit-a-kq",
        vertical: LEAD_GENERATION_VERTICALS.HAIR_RELAXER,
        formname: "Hair Relaxer Lawsuit Form A KQ",
...
py-20
  ...
  "
                  >
                    ...
                    compensation.  Connect 2 Attorney helps connect eligible individuals
...
"
            >
              When you reach out to  Connect 2 Attorney for a hair relaxer <br />{" "}
  ...
  "
            ...
            <div className="relative">
              ...
              >
                {[
                  {
                    text: " Connect 2 Attorney reviewed my case with care, focusing on my diagnosis date, age, product history, and brand, then connected me to an attorney confidently and quickly.",
                    name: "Tamara L.",
                  },
                  {
                    text: "After my cancer diagnosis, I felt lost.  Connect 2 Attorney reviewed relaxer history, confirmed I qualified, and connected me with a lawyer who explained each step.",
                    name: "Angela B.",
                  },
                  {
                    text: "After years of relaxer use, my diagnosis shocked me.  Connect 2 Attorney made intake fast, clarified eligibility, and helped me take the first step toward accountability.",
                    name: "Monique S.",
                  },
                ].map((item, idx) => (
                  <div
...
"
          >
            ...
            hair relaxers, you may be entitled to compensation.  Connect 2 Attorney
...
"
 ...
 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
  ...
  "
          >
            {" "}
            When you reach out to  Connect 2 Attorney for a hair relaxer cancer lawsuit
  ...
  "
            >
               Connect 2 Attorney reviewed my case with care, focusing on my diagnosis
...
"
  ...
  "
            >
              After my cancer diagnosis, I felt lost.  Connect 2 Attorney reviewed
...
"
  ...
  "
            >
              After years of relaxer use, my diagnosis shocked me.  Connect 2 Attorney
