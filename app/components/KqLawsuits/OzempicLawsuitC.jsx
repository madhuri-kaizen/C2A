...
const bgC = "/Form/bgozempic.png";
const bgCM = "/Form/bgozempicm.png";
...
const ozempicC = "/Form/ozempicc.png";
const ozempicCM = "/Form/ozempiccm.png";
import { OzempicLawsuitSendAdminEmail, OzempicLawsuitSendUserEmail } from '../emailService2';
import {
...
const OzempicLawsuitC = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1487428256264538"; //800190089764645 input pixel id 
...
const createEarlyLead = async ({ fullName, phone, email = "" }) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/ozempic-lawsuit-c-kq",
      vertical: LEAD_GENERATION_VERTICALS.OZEMPIC,
      formname: "Ozempic Lawsuit Lander C KQ",
    ...
    try {
      ...
      const retellPayload = {
        countryName: 'USA',
          ...
          vertical: LEAD_GENERATION_VERTICALS.OZEMPIC,
          formPath: '/ozempic-lawsuit-c-kq',
          formname: 'Ozempic Lawsuit Form C KQ',
        data: {
          submissionDate: new Date().toLocaleString(),
  ...
  const handleDesktopSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        Promise.all([
          OzempicLawsuitSendAdminEmail({ formData: payload }),
          OzempicLawsuitSendUserEmail({ formData: payload })
        ]).catch(err => {
...
py-20
 ...
 <h1
  ...
  "
>                  <span className="font-normal">Ozempic Lawsuit:</span>
                  <br />
                   <span className="font-semibold">Vision Loss <br /> Complications?</span>
                </h1>
  ...
  "
>
                  If you used Ozempic (semaglutide) and later experienced NAION vision loss or lasting complications, you may qualify for compensation. Deadlines may apply; check eligibility now. 
                </p>
...
lg:text-[16px]
 ${
                ...
                {[
  { 
    q: "Q1. Have you been diagnosed with NAION (Non-Arteritic Anterior Ischemic Optic Neuropathy)?", 
    name: "q1" 
  },
  {
    q: "Q2. Have you taken GLP-1 medications such as Ozempic, Wegovy, Rybelsus, Trulicity, Mounjaro, or Zepbound?",
    name: "q2",
  },
  {
...
bg-[#F8D216]
            ...
            <div className="grid grid-cols-2 h-full items-center">
              ...
              <div className="max-w-[640px] text-[#162766] pb-10">
                <h2 className="text-[#162766] font-lato text-[40px] font-normal leading-[57.6px] mb-4">
                  When a weight-loss{" "}diabetes drug leads to {" "}
                  <span className="font-bold">life-changing harm?</span>
                </h2>
                <div className="pr-10">
                  <p className="text-[#162766] font-lato text-[24px] font-medium leading-[36px] mb-4 max-w-[640px]">
                                        Ozempic is widely used for type 2 diabetes and is often taken for weight management. But some patients report severe complications ranging from sudden vision loss (NAION) to other serious medical outcomes. 

                  </p>

                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-4 max-w-[420px]">
                                        Lawsuits allege that patients were not adequately warned about certain risks and that complications can require extensive treatment, long-term monitoring, or hospitalization. If your life changed after Ozempic, it may be time to explore your legal options. 
            ...
            <div className="py-16">
                ...
                <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                       NAION and other severe vision injuries can happen suddenly and may be permanent. If you were diagnosed after Ozempic use, you may have a strong claim.
                    </div>
                    </div>
                    ...
                    <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                        Most Ozempic NAION claims require patients to be 75 or younger with a confirmed diagnosis and permanent vision loss. If eligible, you may qualify for screening now. 
                    </div>
                    </div>
                    ...
                    <div className="bg-[#1B2B6B] px-6 py-8 min-h-[130px] flex items-center justify-between">
                        <h3 className="font-lato text-[#FFF] text-[24px] font-bold leading-[36px]">
                        TIME-SENSITIVE <br /> CLAIMS
                        </h3>
                        <img src={symptomsarentsmall} alt="" className="w-12 h-12" />
                    </div>

                    <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                        Drug injury claims may be limited by filing deadlines. Waiting too long can weaken your options, start with a quick eligibility check.
                    </div>
                    </div>
        ...
        <section className="relative w-full bg-white pb-24 overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-10">
                ...
                <div className="text-[#162766]">
                    ...
                    If Ozempic Changed Your Health, You’re Not Alone 
                    </h2>

                     <ul className="space-y-4 font-lato text-[#162766] text-[16px] font-normal leading-[24px] list-disc pl-5  max-w-[720px]">                    <li>
                        If you experienced sudden vision changes, blurred vision, or were diagnosed with NAION, it can be frightening, and it often happens without warning. 
                    </li>
                    <li>
                        Document your Ozempic start and stop dates, symptom onset, and eye records early, as timelines are important for determining eligibility. 
                    </li>
                    <li>
                        Many people only realize something is seriously wrong after ER visits, hospitalizations, specialist appointments, or ongoing treatment that doesn’t improve. 
                    </li>
                    <li>
                        If this happened to you, a case review can help confirm whether your diagnosis, medical records, and timeline may qualify, especially because deadlines may apply. 
                    </li>
                    </ul>
                </div>
                </div>
              ...
              <div className="max-w-[640px] text-[#1B2B6B] pb-10">
                ...
                <div className="pr-10">
                  <p className="font-lato text-[#162766] text-[18px] font-medium leading-normal mb-4 max-w-[500px]">
                    <br />
                    When your health is on the line, you shouldn’t have to fight a pharmaceutical company alone.  Connect 2 Attorney helps connect you with attorneys who review Ozempic injury claims and can tell you, clearly, whether you may qualify. 
                  </p>
                  ...
                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    ...
                    <span className="font-normal">
                         If eligible, compensation may help cover hospital bills, specialist visits, medications, lost income, and long-term care related to your injury. 
                  ...
                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    ...
                    Lawsuits allege that certain serious risks weren’t adequately communicated to patients. If you weren’t warned, you deserve answers. 
                  </p>

                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    <span className="font-semibold">CLEAR NEXT STEPS</span> We keep it simple: quick screening → record review → free attorney case evaluation if you appear eligible. 
                  </p>

                  <p className="text-[16px] font-lato leading-[1.7] text-[#162766]">
                    <span className="font-semibold">NO UPFRONT COST</span> Most cases are handled on a 
        ...
        <section className="w-full bg-[#162B6F] py-20">
            <div className="max-w-[1200px] mx-auto px-10">
                ...
                <div className="text-white text-center flex flex-col items-center">
                    ...
                    <span className="font-semibold">Ozempic claims</span> often involve diagnosed,
                     <span className="font-semibold"> serious complications</span>
                    </h2>
                    ...
                    NAION or gastroparesis after Ozempic? Your case may be worth reviewing. 
                    </p>
                </div>
    ...
    max-w-[480px]
">
                    Ozempic lawsuits commonly involve allegations tied to severe injuries such as NAION 
                    vision loss, gastroparesis, and other serious complications that require 
                    medical intervention. If your diagnosis is documented and symptoms began 
                    after use, you may be eligible to pursue compensation. 
                </div>
    ...
    <div className="max-w-[600px] ml-auto mr-10">                    <h2 className="text-[30px] leading-tight font-normal text-[#1B2B6B] mb-6">
                    <span className="font-semibold">We’ll guide you</span> through the <br /> process
                
                    </h2>

                    <p className=" font-lato text-[#162766] text-[24px] font-medium leading-[28.8px] mb-6  ">
                    If you’re dealing with major health complications, the last thing you need is confusion. A short screening can help determine whether your Ozempic injury may qualify and what records matter most. 
                    </p>
  ...
  transition-colors duration-300
                      ...
                      >
                        <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] bg-white">
                            Many attorneys handle drug injury cases on contingency. That means you typically pay nothing upfront and only pay if compensation is recovered.
                        </div>
                      </div>
 ...
 border-t border-[#E2E6F3]
                      ...
                      >
                        <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] text-[#3E4A6B] bg-white">
                          Diagnosis documentation, treatment history, and timing matter. Legal teams can help identify what supports your claim.
                        </div>
                      </div>
 ...
 border-t border-[#E2E6F3]
                      ...
                      >
                        <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] text-[#3E4A6B] bg-white">
                          State filing deadlines vary. A quick review helps confirm whether you’re still within the window to pursue a claim
                        </div>
                      </div>
  ...
  "
>
                    Why do people choose  Connect 2 Attorney? 
                    </h3>
  ...
  "
>
                     <br />If Ozempic use was followed by a serious diagnosis, it’s worth checking your options now.  
                    </p>
                </div>
                </div>
            </div>
    ...
    leading-[48px]
">
              Ready To Get a Free Ozempic Lawsuit Case Review?
            </h2>
...
>
        ...
        Ozempic Lawsuit: <span className="font-bold">Vision <br />
        Loss Complications?
        </span>
        </h1>
...
>
        ...
        If you used Ozempic (semaglutide) and later experienced NAION vision 
        loss or lasting complications, you may qualify for compensation. 
        Deadlines may apply; check eligibility now. 
        </p>
    </div>
    </div>
...
">Email</label>
            ...
            {[
              "Have you been diagnosed with NAION (Non-Arteritic Anterior Ischemic Optic Neuropathy)?",
              "Have you taken GLP-1 medications such as Ozempic, Wegovy, Rybelsus, Trulicity, Mounjaro, or Zepbound?",
...
>
                ...
                When a weight-loss/
                <br />
                diabetes drug leads <br />
                to <span className="font-bold">life-changing harm.</span>
                </h2>
...
>
            ...
            <div className="flex justify-center">
                 <ul className="space-y-4 font-lato text-[#162766] text-[16px] font-normal leading-[24px] list-disc pl-5  max-w-[720px]">                    <li>
                    ...
                    <li>
                        Women are increasingly seeking legal reviews after meningioma diagnoses following Depo shot use. 
                    </li>
                    </ul>
            </div>
...
>
                ...
                Ozempic Lawsuit 
                <span className="font-semibold">  help <br /> Starts Here</span>
                </h2>
...
>
                ...
                <span className="font-semibold">MEDICAL COST RECOVERY</span>{" "}
                If eligible, compensation may help cover hospital bills, specialist visits, medications, lost income, and long-term care related to your injury.
                </p>
                ...
                <p className="text-[16px] font-lato leading-[22px] mb-4">
                <span className="font-semibold">CLEAR NEXT STEPS</span>{" "}
                We keep it simple: quick screening → record review → free attorney case evaluation if you appear eligible.
                </p>
      ...
      <section className=" lg:hidden w-full bg-[#162766] px-5 py-14 text-center">
            ...
            <h2 className="text-[28px] font-lato leading-[32px] font-semibold text-white mb-4">
                Ozempic claims often <br /> involve diagnosed, <br />serious complications
            </h2>
            ...
            <p className="text-[18px] font-lato leading-[24px] text-white mb-10">
                NAION after Ozempic? Your case may be worth reviewing. 
            </p>

            {/* ===== MAIN PARAGRAPH ===== */}
            <p className="text-[16px] font-lato leading-[26px] text-white max-w-[320px] mx-auto">
                Ozempic lawsuits commonly involve allegations tied to severe injuries such as NAION vision loss and other serious complications that require medical intervention. If your diagnosis is documented and symptoms begin after use, you may be eligible to pursue compensation. 
                <br /><br />
                Check eligibility today; deadlines may apply. 
            </p>
      ...
      <section className=" lg:hidden relative w-full bg-white px-5 pt-10 pb-20 overflow-hidden">
            ...
            <h2 className="text-[30px] font-lato leading-tight font-normal text-[#162766] mb-4">
                <span className="font-semibold">We’ll guide you through the process.</span>
            </h2>
            ...
            <p className="text-[16px] font-lato leading-[22px] mb-4">
                If Ozempic use was followed by a serious diagnosis, it’s worth checking your options now. 
            </p>
      ...
      <section className=" lg:hidden relative w-full bg-[#162B6F] py-10">
            ...
            <div className="px-5 text-center">
                ...
                Ready To Get a Free <br />
                 Ozempic Lawsuit<br />Case Review?
                </h2>
...
export default OzempicLawsuitC;