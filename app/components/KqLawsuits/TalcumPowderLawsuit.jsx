...
import {
  TalcumPowderLawsuitSendAdminEmail,
  TalcumPowderLawsuitSendUserEmail,
} from "../emailService2";
import {
...
const TalcumPowderLawsuit = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "924131140519620"; //last one : 1409965080153428
  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/talcum-powder-lawsuit-a-kq",
        vertical: LEAD_GENERATION_VERTICALS.TALCUM,
        formname: "Talcum Powder Lawsuit Lander Form A KQ",
...
"
                >
                  Get your free case review today, no upfront fees!
                </p>
              </div>
            </div>
...
"
                      >
                        <span className="font-bold"> Q1. </span> Which condition
                      ...
                      >
                        ...
                        <option value="Fallopian tube cancer">
                          Fallopian tube cancer
                        </option>
                        <option value="Primary peritoneal cancer">
                          Primary peritoneal cancer
                        </option>
                        <option value="Adenosarcoma">Adenosarcoma</option>
        ...
        "
                          >
                            <span className="font-bold">{qNumber}</span> {qText}
                          </p>
...
"
    ...
    mx-auto"
                >
                  Complete a short, secure form focused on your talcum powder
                  use and ovarian cancer diagnosis.
                </p>
              </div>
...
"
    ...
    mx-auto"
                >
                  ...
                  the criteria for a Talcum Powder lawsuit.
                </p>
              </div>
...
"
              >
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on talcum powder-caused cancer claims. 
                  </span>
                </li>
...
"
 ...
 mb-2 block"
              >
                <span className="font-bold">Q1. </span> Which condition were you
                diagnosed with?
              </label>
              <select
 ...
 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
  ...
  "
            >
              Complete a short, secure form focused on your talcum powder use
  ...
  "
          >
            ...
            <li className="flex gap-3">
              ...
              <span>
                We use clear, criteria-based screening focused on talcum
                powder-caused cancer claims.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                We connect qualified individuals with attorneys in product
...
export default TalcumPowderLawsuit;
