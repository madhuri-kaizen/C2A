...
const kidMobile = "/Form/kidmobile.png";
const lawyerReadingS = "/Form/lawyerreadingsmall.png";
const roblox = "/Form/roblox.png";
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/roblox-sa-lawsuit-b-kq",
      vertical: LEAD_GENERATION_VERTICALS.ROBLOX,
      formname: "Roblox Sex Abuse Lawsuit Form B KQ",
...
>
                  ...
                  <br />
                   Lawsuit: <span className="text-[#F8D216]">Check Eligibility</span> for
                  <br />
                   Compensation with
                   <br />
                    Connect2Attorney
                ...
                <p className="text-[13.5px] text-gray-300 mb-4 leading-relaxed tracking-wide">
                  ...
                  ✅ We screen for key criteria (Roblox contact, age, adult abuser, injury, proof options)  <br />
                  ✅ No upfront cost to see if you qualify<br />
                  ✅ If eligible, we connect you with an attorney for the next steps <br /> <br />
                </p>
...
leading-tight font-semibold text-[#162766] mb-4">
                    Understanding Roblox Grooming, Sextortion, and the Roblox Sex Abuse Lawsuit 
                </h2>
...
">
                    Roblox is popular with kids and teens, and predators may use chats or in-game messages to gain trust. Grooming often starts on Roblox and then moves to apps like Discord or Snapchat, where a child may be pressured or threatened into sending explicit content. 
                </p>
...
">
                    Roblox sex abuse lawsuits question whether safety tools and warnings were strong enough to protect children from grooming, sextortion, exploitation, or in-person abuse. Claims may involve documented harm like anxiety, depression, PTSD, school issues, therapy, or medical care. 
                </p>
...
">
                    Roblox Sex Abuse Lawsuit Eligibility Requirements 
                </h2>
...
">
                    A claim may qualify if Roblox was the starting point; the child was a minor, the abuser was an adult, and the abuse caused real harm. Here’s the simple checklist: 
                </p>
...
">
                    <li className="flex gap-3">
                        ●
                    <span>
                     <strong>Met on Roblox first:</strong> Your child met the abuser through Roblox (if they met elsewhere first, it typically won’t qualify). 
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>Child’s age:</strong> Your child was under 17 when the grooming/abuse began. 
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>Adult abuser:</strong> The abuser was over 18 (if you’re unsure of exact age, you can still submit if the rest fits).  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>What happened (one qualifies):</strong> Grooming, sextortion, explicit image requests/exchange, repeated sexual messages, meeting in person, sexual assault, attempted assault, or trafficking/exploitation. 
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        <strong>Harm & support:</strong> Your child experienced harm and/or got help like therapy, counseling, medical care, school records, or a diagnosis like anxiety, depression, PTSD, or suicidal ideation.  
                    </span>
                    </li>
...
font-lato
    ...
    xl:text-[17px]">
                    ...
                    quick, confidential form to see if you qualify for a Roblox sex abuse
...
leading-relaxed
 text-[#162766] mb-2">
  ...
  "
>
                    Get matched with experienced Roblox child sex abuse lawyers.
                    </p>
                </div>
...
>
    ...
    leading-[48px]
">
              Ready To Get a Free Roblox Child Sex <br />Abuse Lawsuit Review?
            </h2>
...
>
            ...
            confidential form to see if you qualify for a Roblox sex abuse lawsuit. Our
...
>
            ...
            Child Sex Abuse Lawsuit Review?
          </h2>
...
export default RobloxSALawsuitB;
