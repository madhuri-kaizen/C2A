  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/depo-provera-lawsuit-b-kq",
        vertical: LEAD_GENERATION_VERTICALS.DEPO_PROVERA,
        formname: "Depo-Provera Lawsuit Lander B KQ",
...
py-20
  ...
  "
                >
                  ...
                  <span className="text-[#F8D216]">Check</span>
                  <br />
                  <span className="text-[#F8D216]">Your Eligibility</span> for
                  Compensation
                  <br />
                  with  Connect 2 Attorney
                </h1>
  ...
  "
                >
                  ...
                  entitled to financial compensation.  Connect 2 Attorney helps you
                  quickly understand your legal options and connect with
                  experienced Depo-Provera lawsuit lawyers.
                  <br />
                  <br />
                  <span className="font-bold">
                    Why choose  Connect 2 Attorney for your Depo-Provera lawsuit?
                  </span>
                  <br />
                  <br />
                  ✅ Fast and confidential case review <br />
                  ✅ Access to attorneys handling Depo-Provera and meningioma
                  claims <br />
                  ✅ No upfront fees to check your eligibility <br />✅ Simple
                  online process designed for patients and families <br />{" "}
                  <br />
                </p>
...
lg:text-[16px]
 ${desktopTouched.email && desktopErrors.email
                    ...
                    {[
                      {
                        qLabel: "Q1.",
                        qText: "Have you been diagnosed with meningioma?",
                        name: "q1",
                      },
                      {
                        qLabel: "Q2.",
      ...
      "
                        >
                          <span className="font-bold mr-1">{qLabel}</span>
                          {qText}
                        </p>
...
leading-tight font-semibold text-[#162766] mb-4"
              >
                ...
                <br />
                Meningioma Risks, & the Depo-Provera
                <br />
                Brain Tumor Lawsuit
              </h2>
    ...
    leading-[28px]
     ...
     max-w-[720px]"
              >
                Depo-Provera is an injectable birth control shot containing
                medroxyprogesterone acetate, given every three months, and also
                sold as Depo-SubQ Provera. Recent studies and patient reports
                suggest a possible link between long-term Depo-Provera use and
...
"
              >
                As a result, lawsuits have been filed by individuals who were
                diagnosed with meningioma after receiving Depo-Provera
                injections. These lawsuits claim the manufacturers failed to
                properly warn patients and healthcare providers about the
                potential risk of brain tumors and seek compensation for medical
                costs, lost income, and related damages.
              </p>
...
"
              >
                 Connect 2 Attorney helps affected individuals connect with qualified
...
"
              >
                ...
                <br />
                Requirements for Meningioma Compensation
              </h2>
...
"
              >
                To qualify for a Depo-Provera lawsuit through  Connect 2 Attorney, you
...
"
              >
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[14px] h-[7px] rounded-full bg-[#4B5563]" />
                  <span>
                    <strong>Meningioma after Depo use</strong> – Diagnosed with
                    meningioma after using Depo-Provera or Depo-SubQ Provera,
                    with at least a 2-year gap from first injection to
                    diagnosis.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[14px] h-[7px] rounded-full bg-[#4B5563]" />
                  <span>
                    <strong>Approved product & minimum dosage</strong> – Used
                    brand-name Depo-Provera (Pfizer) or an authorized generic,
                    or Depo-SubQ Provera, for at least two injections/doses.
                  </span>
                </li>

                <li className="flex gap-3">
                  <span className="mt-[10px] w-[7px] h-[6px] rounded-full bg-[#4B5563]" />
                  <span>
                    <strong>Valid time frame & U.S. use</strong> – Depo use must
                    be after 1992 and within the United States.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[14px] h-[7px] rounded-full bg-[#4B5563]" />
                  <span>
                    <strong>Location & demographic limits</strong> – Must be a
                    biological female, born before 1990, and not from Alabama,
                    Louisiana, Kentucky, Tennessee, Texas, or Mississippi.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[14px] h-[7px] rounded-full bg-[#4B5563]" />
                  <span>
                    <strong>Legal & admin status</strong> – Not currently
                    represented by an attorney, can confirm a valid U.S. SSN,
                    and the claim must be within the statute of limitations.
                  </span>
                </li>
              </ul>
...
font-lato
    ...
    lg:text-[16px]
    xl:text-[17px]">
                Don’t wait! Your legal rights may be limited by time. Fill out
                our quick, confidential form to see if you qualify for a
                Depo-Provera lawsuit. Our experienced attorneys will review your
                case for free and guide you through the process.
              </p>
...
transition-colors
  ...
  "
                >
                  Get matched with experienced Depo-Provera lawyers.
                </p>
              </div>
...
"
          >
            ...
            financial compensation.  Connect 2 Attorney helps you quickly understand
...
mb-2"
 ...
 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
      ...
      <section className=" lg:hidden w-full bg-[#FAF8E9] px-4 py-10">
        <div className="max-w-[360px] mx-auto">
          ...
          <div className="mb-6">
            <img
              src={tensedWoman}
              alt="Woman holding Depo-Provera vial"
  ...
  "
          >
            Depo-Provera is an injectable birth control shot containing
            medroxyprogesterone acetate, given every three months, and also sold
            as Depo-SubQ Provera. Recent studies and patient reports suggest a
            possible link between long-term Depo-Provera use and meningioma, a
            type of brain tumor.
          </p>
  ...
  "
          >
            As a result, lawsuits have been filed by individuals who were
            diagnosed with meningioma after receiving Depo-Provera injections.
            These lawsuits claim the manufacturers failed to properly warn
            patients and healthcare providers about the potential risk of brain
            tumors and seek compensation for medical costs, lost income, and
            related damages.
          </p>
...
md:leading-[46px]
  ...
  "
          >
            To qualify for a Depo-Provera lawsuit through  Connect 2 Attorney, you must
  ...
  "
          >
            ...
            <p>
              <strong>Meningioma after Depo use</strong> – Diagnosed with
              meningioma after using Depo-Provera or Depo-SubQ Provera, with at
              least a 2-year gap from first injection to diagnosis.
            </p>
            <p>
              <strong>Approved product & minimum doses</strong> – Used
              brand-name Depo-Provera (Pfizer) or an authorized generic, or
              Depo-SubQ Provera, for at least two injections/doses.
            </p>
            <p>
              <strong>Valid time frame & U.S. use</strong> – Depo use must be
              after 1992 and within the United States.
            </p>
            <p>
              <strong>Location & demographic limits</strong> – Must be a
              biological female, born before 1990, and not from Alabama,
            ...
            <p>
              <strong>Legal & admin status</strong> – Not currently represented
              by an attorney, can confirm a valid U.S. SSN, and the claim must
    ...
    text-center
      ...
      <section className=" lg:hidden relative w-full bg-white overflow-hidden">
        {/* Waves background */}
        <img src={wavesMobile} alt="" className="w-full block" />
...
md:leading-[28px]
  "
          >
            ...
            quick, confidential form to see if you qualify for a Depo-Provera
...
export default DepoProveraLawsuitB;
