...
import { RoundupLawsuitSendAdminEmail, RoundupLawsuitSendUserEmail } from '../emailService2';
import {
...
const RoundupLawsuit = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1983056132615475"; //last one : 1409965080153428
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/roundup-lawsuit-a-kq",
      vertical: LEAD_GENERATION_VERTICALS.ROUNDUP,
      formname: "Roundup Lawsuit Form A KQ",
  ...
  //       Promise.all([
  //         RoundupLawsuitSendAdminEmail({ formData: payload }),
  //         RoundupLawsuitSendUserEmail({ formData: payload })
  //       ]).catch(err => {
...
">
                  If you used Roundup and were later diagnosed with Non-Hodgkin’s 
                  Lymphoma or a related blood cancer, you may have legal options. If 
                  your diagnosis occurred within the last 20 years and you used these 
                  products for several years before diagnosis, you may qualify to seek 
                  compensation. Request a free, confidential case review today.
                </p>
...
lg:text-[16px]
 ${
                    ...
                    {[
  { 
    q: "Q1. Have you been diagnosed with Non-Hodgkin’s Lymphoma (NHL) or a related lymphoma condition?", 
    name: "q1" 
  },
  {
    q: "Q2. Did you use Roundup for 2 or more years before your diagnosis?",
    name: "q2",
  },
  {
    q: "Q3. Are you currently represented by an attorney for this diagnosis?",
    name: "q3",
  },
].map(({ q, name }) => (
...
">
    ...
    max-w-[260px]
    mx-auto">
                  We collect key details about your diagnosis, age at diagnosis, and history of Roundup, use without requesting sensitive medical records at this stage.
                </p>
              </div>
...
">
    ...
    max-w-[260px]
    mx-auto">
                  We verify your Non-Hodgkin’s Lymphoma or qualifying diagnosis, confirm exposure timeline, product usage duration, & ensure you meet the case criteria before proceeding.
                </p>
              </div>
...
">
    ...
    max-w-[260px]
    mx-auto">
                  If eligible, you are connected with a qualified attorney who will review your case, explain your legal options, and guide you through the next steps.
                </p>
              </div>
            </div>
...
">
                ...
                current legal requirements before connecting you with an attorney. 
              </p>
...
">
                <li className="flex gap-3">
                  ...
                  <span>
                    We use clear, criteria-based screening focused on qualifying Roundup cancer claims.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    We only guide you forward if your case meets the established lawsuit criteria.
                  </span>
                </li>
                ...
                <li className="flex gap-3">
                  <span className="mt-[10px] w-[6px] h-[6px] rounded-full bg-[#555555]" />
                  <span>
                    We connect you with attorneys experienced in handling Roundup-related cancer litigation. 
                  </span>
                </li>
    ...
    leading-[48px]
">
              Ready To Get a Free Roundup <br /> 
              Lawsuit Review?
            </h2>
...
">
    ...
    mb-6
">
            If you used Roundup and were later diagnosed 
            with Non-Hodgkin’s Lymphoma or a related blood cancer, 
            you may have legal options. If your diagnosis 
            occurred within the last 20 years and you used 
            these products for several years before diagnosis, 
            you may qualify to seek compensation. Request a 
...
">Email</label>
            ...
            {[
              "Have you been diagnosed with Non-Hodgkin’s Lymphoma (NHL) or a related lymphoma condition?",
              "Did you use Roundup for 2 or more years before your diagnosis?",
              "Are you currently represented by an attorney for this diagnosis?",
            ].map((q, i) => (
              <div key={i}>
                <p className="  font-lato
    text-[#191B37]
...
>             Connect2Attorney helps individuals explore Roundup cancer 
            ...
            determine whether your case meets current legal requirements 
            before connecting you with an attorney.
          </p>
...
>            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                We guide you only if your case meets the established lawsuit criteria.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="mt-[8px] w-[5px] h-[5px] rounded-full bg-[#4B5563]" />
              <span>
                We connect you with attorneys experienced in handling Roundup-related 
                cancer litigation.
              </span>
            </li>
