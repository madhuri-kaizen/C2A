...
const OzempicLawsuitD = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1384766283666943"; //800190089764645 input pixel id 
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/ozempic-lawsuit-d-kq",
      vertical: LEAD_GENERATION_VERTICALS.OZEMPIC,
      formname: "Ozempic Lawsuit Lander D KQ",
    ...
    try {
      ...
      const retellPayload = {
        countryName: 'USA',
          ...
          vertical: LEAD_GENERATION_VERTICALS.OZEMPIC,
          formPath: '/ozempic-lawsuit-d-kq',
          formname: 'Ozempic Lawsuit Form D KQ',
        data: {
          submissionDate: new Date().toLocaleString(),
            ...
            <div className="pt-0 mt-20 text-white flex justify-center">
              <div className=" max-w-[720px]">
                 <h1 className="text-[32px] sm:text-[34px] md:text-[38px] lg:text-[42px] xl:text-[46px] leading-snug font-semibold mb-4">
                   Ozempic Lawsuit: Diagnosed With NAION While Taking Ozempic? <span className="bg-[#162766] text-[#F8D216] px-3 py-[3px] rounded-md inline-block">
                       You May Qualify
                    </span>
                ...
                <p className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed tracking-wide text-white mb-4">
                  People diagnosed with NAION, a sudden optic nerve injury that can cause permanent vision loss, may be eligible for legal help if the condition occurred while taking a brand-name GLP-1 drug and the medication was stopped at diagnosis.     
                </p>
                 ...
                 <ul className="mt-6 space-y-4 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] xl:text-[19px] text-white">
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                        <span className="font-semibold">NAION (Non-Arteritic Anterior Ischemic Optic Neuropathy)</span> diagnosis (required)  
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                         Happened while actively taking a brand-name <span className="font-semibold">GLP-1 (like Ozempic)</span>  and you stopped at diagnosis 
                        </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <span>
                         Permanent vision impairment and  
                          <span className="font-semibold"> age 75 or younger  </span>
                        </span>
                    </li>
                </ul>
              </div>
...
">
                ...
                What an Ozempic NAION Lawsuit Claim May Include 
                </h2>
                ...
                If you meet the criteria, your claim may seek compensation for the medical, 
                financial, and personal impact of NAION-related vision damage. 
                <span className="font-semibold"> Qualified claims commonly involve: </span> 
                </p>
                ...
                <li className="flex items-start gap-2">
                    ...
                    Eye care and medical costs (specialists, imaging, follow-up treatment) 
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                ...
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Pain, suffering, and life impact from permanent vision changes  
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Out-of-pocket costs tied to appointments, transportation, and care 
                </li>
                </ul>

                {/* ===== SECTION 2 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                NAION Vision Loss Claims Focus on Timing: Active Use, Diagnosis, and Stopping the Drug 
                </h3>
                ...
                <p>
                    Eligibility requires a confirmed diagnosis of Non-Arteritic Anterior Ischemic Optic Neuropathy (NAION) with some degree of permanent vision impairment. 
                </p>

                <p>
                    The injury must have occurred while you were actively taking a brand-name GLP-1 medication (no compounded or generic versions), and you must have stopped taking it at the time of diagnosis.  
                </p>

                <p>
                    Intake is limited to people who were 75 or younger, are not currently incarcerated, and are not represented by another attorney for this matter.   
                </p>

                <p>
                    Filing deadlines depend on your state and diagnosis date. If the statute of limitations has expired (or near the cutoff), the claim must be declined, so checking early matters.  
                </p>
                </div>

                {/* ===== SECTION 3 ===== */}
                <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
                NAION Vision Loss Symptoms Linked to Ozempic and Other GLP-1 Drugs 
                </h3>
                ...
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Blurred or “dim” vision that worsens quickly  
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Loss of visual field (dark area or missing section of sight)     
                </li>
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                ...
                <li className="flex items-start gap-2">
                    <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                    Vision not returning to normal after the event 
                </li>
                </ul>
...
/>
        ...
        <div className="px-4 pt-12 pb-16 text-white">
            ...
            Ozempic Lawsuit: Diagnosed With NAION While Taking Ozempic
             {"  "}{"  "}
 ...
 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
      ...
      <div className=" lg:hidden w-full bg-[#162766]">
            <div className=" max-w-[720px] px-4 py-10 text-white font-jakarta">
                ...
                <li className="flex items-start gap-3">
                    ...
                    <span>
                     Permanent vision impairment and  <span className="font-semibold">age 75 or younger </span>
                    </span>
                </li>
                </ul>
            </div>
      ...
      <section className=" lg:hidden w-full bg-white py-10">
            <div className="px-4 font-jakarta text-[#162766]">
                ...
                If you meet the criteria, your claim may seek compensation for 
                the medical, financial, and personal impact of NAION-related 
                vision damage. 
                  
                <span className="font-bold"> Qualified claims commonly involve: </span>  
                </p>

                <ul className="space-y-5 font-semibold text-[16px] mb-8">
                {[
                    "Eye care and medical costs (specialists, imaging, follow-up treatment) ",
                    "Vision-related expenses (adaptive devices, rehab, ongoing monitoring) ",
                    "Lost wages and reduced ability to work ",
                    "Pain, suffering, and life impact from permanent vision changes ",
                    "Out-of-pocket costs tied to appointments, transportation, and care  ",
                ].map((item, idx) => (
                ...
                <h3 className="text-[24px] font-bold mb-4 leading-snug">
                  NAION Vision Loss Claims Focus on Timing: Active Use, Diagnosis, and Stopping the Drug  </h3>
      ...
      <section className=" lg:hidden w-full bg-[#162B6F] py-10">
        <div className="px-5 text-center">
          <h2 className="text-[26px] leading-[30px] font-semibold text-white mb-3">
            Ready To Get a Free Ozempic<br />
            Lawsuit Case Review?
          </h2>
...
export default OzempicLawsuitD;