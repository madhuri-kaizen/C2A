...
const rideC = "/Form/ridesharec.png";
const rideCM = "/Form/ridesharecm.png";
import { RideshareSALawsuitSendAdminEmail, RideshareSALawsuitSendUserEmail } from '../emailService2';
import {
...
const RideshareSexualAssaultLawsuitC = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1657036335514037";//3008360769359573 //1679236040107644 input pixel id 
...
const createEarlyLead = async ({ fullName, phone, email = "" }) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/rideshare-sa-lawsuit-c-kq",
      vertical: LEAD_GENERATION_VERTICALS.RIDESHARE,
      formname: "Rideshare Sexual Assault Lawsuit Lander C KQ",
    ...
    try {
      ...
      const retellPayload = {
        ...
        data: {
          ...
          wasOffenderUberLyftDriver: payload.q1,
          whatHappened: payload.q2,
  ...
  const handleDesktopSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        Promise.all([
          RideshareSALawsuitSendAdminEmail({ formData: payload }),
          RideshareSALawsuitSendUserEmail({ formData: payload })
        ]).catch(err => {
...
py-20
 ...
 <h1
  ...
  "
>                  <span className="font-normal">Sexually Assaulted in <br /> an Uber or Lyft?</span>
                  
                    <span className="font-semibold"> Get a <br /> Free Case Review</span>
                </h1>
  ...
  "
>
                  Uber/Lyft assault claims often depend on proof of the ride and the type of contact involved. Start with a private screening to see if you meet the requirements.   
                </p>
...
lg:text-[16px]
 ${
    ...
    leading-[28px]
">
                      <span className="font-bold">Q1. </span>  Was the offender your Uber/Lyft driver during a ride?
                      </p>
                      <div className="grid grid-cols-2 gap-3">
                        {["Yes", "No"].map((opt) => (
                          <label
                          ...
                          >
                            <input
                              ...
                              name="q1"
                              value={opt}
                              checked={desktopFormData.q1 === opt}
                              onChange={(e) => {
...
">{opt}</span>
                    ...
                    {/* Q2 - Dropdown (was previously Q1, unchanged markup) */}
                    <div className="space-y-1">
                      <label className="  font-lato
    text-[#191B37]
    text-[15.8px]
    ...
    leading-[28px]
">
                      <span className="font-bold">Q2. </span>  What best describes what happened?
                      </label>
                      <select
                        value={desktopFormData.q2}
                        onChange={(e) =>
                          setDesktopFormData({ ...desktopFormData, q2: e.target.value })
                        }
                        className={`w-full border rounded-md px-3 py-3 text-[13px] ${
                          desktopTouched.q2 && desktopErrors.q2
                            ? "border-red-500 focus:border-red-500"
                            : "border-[#D7DBEA]"
                        }`}
                      >
                        <option value="">Please select an option</option>
                        <option value="Forced sexual act (forced oral, forced manual stimulation)">Forced sexual act (forced oral, forced manual stimulation)</option>
                        <option value="Non-consensual sexual touching or kissing of a sexual body part">Non-consensual sexual touching or kissing of a sexual body part</option>
                        <option value="Indecent exposure / masturbation">Indecent exposure / masturbation</option>
                        <option value="Kidnapping / false imprisonment with overt sexual or extreme physical threats">Kidnapping / false imprisonment with overt sexual or extreme physical threats</option>
                        <option value="Other">Other</option>
                        <option value="None of the above">None of the above</option>
                      </select>
                      {desktopTouched.q2 && desktopErrors.q2 && (
                        <span className="text-[11px] text-red-500">{desktopErrors.q2}</span>
                      )}
                    </div>
    ...
    leading-[28px]
">
                      <span className="font-bold">Q3. </span>  Are you currently working with an attorney or have you already filed a rideshare claim for this incident?
                      </p>
                      <div className="grid grid-cols-2 gap-3">
                        {["Yes", "No"].map((opt) => (
                          <label
                          ...
                          >
                            <input
                              ...
                              name="q3"
                              value={opt}
                              checked={desktopFormData.q3 === opt}
                              onChange={(e) => {
                                setDesktopFormData({ ...desktopFormData, q3: e.target.value });
                              }}
                              className="peer hidden"
                            />
...
">{opt}</span>
                      ...
                      {desktopTouched.q3 && desktopErrors.q3 && (
                        <span className="text-[11px] text-red-500">{desktopErrors.q3}</span>
                      )}
                    </div>
    ...
    font-normal">
                        ...
                        />
                        <span>
                          I agree to the <a href="/PrivacyPolicy" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 font-bold">Privacy Policy</a>{' '}
                          and <a href="/Disclaimer" target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 font-bold">Disclaimer</a> and give my express written consent,
                          affiliates and/or lawyer to contact you at the number provided above, even if this number is a wireless number or if I am presently listed on a Do Not Call list. 
                          I understand that I may be contacted by telephone, email, text message or mail regarding case options and that I may be called using automatic dialing equipment. 
                          Message and data rates may apply. My consent does not require purchase. This is Legal advertising.
                        </span>
                      </label>
              ...
              <div className="max-w-[640px] text-[#162766] pb-10">
                <h2 className="text-[#162766] font-lato text-[40px] font-normal leading-[57.6px] mb-4">
                  Your safety was violated.{" "}
                     <span className="font-semibold"> You deserve support </span> and  
                     <span className="font-semibold"> a path forward.</span>                </h2>
                <div className="pr-10">
                  <p className="text-[#162766] font-lato text-[24px] font-medium leading-[36px] mb-4 max-w-[640px]">
                                       A rideshare is supposed to be a safe way home, not a situation where you’re trapped, threatened, or touched without consent. If you were sexually assaulted by an Uber or Lyft driver, you may be eligible to pursue compensation, especially when the assault involved physical contact, happened in or around the vehicle, and you can provide (or obtain) your ride receipt.   
                  ...
                  <p className="font-roboto text-[#162766] text-[16px] font-bold leading-[24px]">
                    What happened is not your fault. A case review can help you understand what qualifies and what steps protect your rights.   
                  </p>
                </div>
              </div>
            ...
            <div className="py-16">
                ...
                <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="bg-[#162766] px-6 py-8 min-h-[130px] flex items-center justify-between">
                        ...
                        IT HAPPENED <br /> DURING THE RIDE
                        </h3>
                    ...
                    <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                       If the assault occurred in the car, just outside it, or as part of the ride situation, it may qualify, even if it continued after the drop-off.
                    </div>
                    </div>
                    ...
                    <div className="bg-[#162766] px-6 py-8 min-h-[130px] flex items-center justify-between">
                        <h3 className="font-lato text-[#FFF] text-[24px] font-bold leading-[36px]">
                        MEDICAL, THERAPY <br />  & TIME OFF
                        </h3>
                        <img src={dollarbag} alt="" className="w-12 h-12" />
                    </div>

                    <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                        After an assault, costs can include ER visits, counseling, medication, missed work, and long-term care. Compensation may help relieve that burden.  
                    </div>
                    </div>
                    ...
                    <div className="bg-[#1B2B6B] px-6 py-8 min-h-[130px] flex items-center justify-between">
                        <h3 className="font-lato text-[#FFF] text-[24px] font-bold leading-[36px]">
                        DEADLINES CAN <br /> LIMIT CLAIMS
                        </h3>
                        <img src={symptomsarentsmall} alt="" className="w-12 h-12" />
                    </div>

                    <div className="px-6 py-6 font-lato text-[#162766] text-[16px] font-normal leading-[24px]">
                        Filing windows vary by state. A quick review can confirm whether your case may still be within the statute of limitations.
                    </div>
                    </div>
        ...
        <section className="relative w-full bg-white pb-24 overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-10">
                ...
                <div className="text-[#162766]">
                    ...
                    What Typically Matters in Rideshare Assault Claims?  
                    </h2>

                     <ul className="space-y-4 font-lato text-[#162766] text-[16px] font-normal leading-[24px] list-disc pl-5  max-w-[720px]">                    <li>
                        The offender was an Uber or Lyft driver (not another passenger).  
                    </li>
                    <li>
                        The incident involved physical sexual contact (not only messages or verbal harassment).  
                    </li>
                    <li>
                        You can provide the ride receipt or confirm you can obtain it.  
                    </li>
                    <li>
                        You told someone Uber/Lyft, police, a medical provider, a therapist, or a trusted person, near the time it happened.  
                    </li>
                    <li>
                        The incident is within the time limit allowed in your state (some states have extended windows).  
                    </li>
                    </ul>
                </div>
                </div>
            ...
            <div className="grid grid-cols-2 h-full items-center">
              ...
              <div className="max-w-[640px] text-[#1B2B6B] pb-10">
                <h2 className="font-lato text-[#162766] text-[40px] font-normal leading-normal mb-4">
                  You don't have to carry this alone. <br/>We help you{" "}
                ...
                <div className="pr-10">
                  <p className="font-lato text-[#162766] text-[18px] font-medium leading-normal mb-4 max-w-[500px]">
                    <br />
                                      After a rideshare assault, survivors often feel overwhelmed, unsure what counts, who will believe them, and what proof matters. Our job is to make the first step simple, respectful, and private.  
                  ...
                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    ...
                    <span className="font-normal">
                                               Share what happened in a secure screening. We focus on the facts that drive eligibility, ride receipt, location/timing, and type of contact

                    </span>
                  </p>

                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    <span className="font-semibold">TRAUMA-INFORMED SUPPORT</span>{" "}
                    You control the pace. We can connect you with attorneys who handle these cases with sensitivity, not pressure. 
                  </p>

                  <p className="font-lato text-[#162766] text-[16px] font-normal leading-[24px] mb-6">
                    <span className="font-semibold">DOCUMENTATION SUPPORT</span> We
                    If you don’t have the ride receipt or records yet, we’ll tell you what to request and what details to gather so your case review is stronger.
                  </p>
        ...
        <section className="w-full bg-[#162B6F] py-20">
            <div className="max-w-[1200px] mx-auto px-10">
                ...
                <div className="text-white text-center flex flex-col items-center">
                    ...
                    <span className="font-semibold">Confidential Case Reviews</span>
                    </h2>
...
">
    ...
    <div className="max-w-[600px] ml-auto mr-10">                    <h2 className="text-[30px] leading-tight font-normal text-[#1B2B6B] mb-8">
                    <span className="font-semibold">We’ll help you</span> understand what <br /> qualifies,
  ...
  transition-colors duration-300
                      ...
                      >
                        <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] bg-white">
                            Many claims are handled on contingency—no upfront fees in most cases.
                        </div>
                      </div>
 ...
 border-t border-[#E2E6F3]
                      ...
                      >
                        <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] text-[#3E4A6B] bg-white">
                          Ride receipt, timeline, reporting, and any medical/therapy records can strengthen a claim.
                        </div>
                      </div>
 ...
 border-t border-[#E2E6F3]
                      ...
                      >
                        <div className="px-5 py-4 text-[16px] font-lato leading-[1.6] text-[#3E4A6B] bg-white">
                          State time limits vary. A review helps confirm whether you may still be eligible.
                        </div>
                      </div>
...
>
                    ...
                    <li>
                        Assault by an Uber/Lyft driver     
                    </li>
                    <li>
                        Physical contact (including qualifying tiers) 
                    </li>
                    <li>
                        Receipt confirmation    
                    </li>
                    <li>
                        Reporting pathway (rideshare company, police, medical, therapist, or trusted person)    
                    </li>
                    <li>
                        Deadline checks based on your state     
                    </li>
                    </ul>
                </div>
                </div>
    ...
    leading-[48px]
">
              Ready To Get a Free Rideshare Sexual <br /> Assault Lawsuit Review?
            </h2>
...
>
        ...
        Sexually Assaulted in an <br /> Uber or Lyft?
        <span className="font-bold"> Get a Free <br />
        Case Review
        </span>
        </h1>
...
">Email</label>
 ...
 mb-2">
            ...
            {/* Q2 - Dropdown (was previously Q1, markup untouched) */}
            <div>
              <label className="   font-lato
    text-[#191B37]
    text-[15.8px]
 ...
 Q2. </span>   What best describes what happened?
              </label>
              <select
                value={mobileFormData.q2}
                onChange={(e) =>
                  setMobileFormData({ ...mobileFormData, q2: e.target.value })
                }
                className={`w-full border rounded-md px-3 py-3 text-[13px] ${
                  mobileTouched.q2 && mobileErrors.q2
                    ? "border-red-500 focus:border-red-500"
                    : "border-[#D7DBEA]"
                }`}
              >
              ...
              {mobileTouched.q2 && mobileErrors.q2 && (
                <span className="text-[11px] text-red-500">{mobileErrors.q2}</span>
              )}
            </div>
 ...
 mb-2">
                ...
                {["Yes", "No"].map((opt) => (
                  ...
                  >
                    <input
                      ...
                      name="mq3"
                      value={opt}
                      checked={mobileFormData.q3 === opt}
                      onChange={(e) => {
                        setMobileFormData({ ...mobileFormData, q3: e.target.value });
                      }}
                      className="peer hidden"
                    />
              ...
              {mobileTouched.q3 && mobileErrors.q3 && (
                <span className="text-[11px] text-red-500">{mobileErrors.q3}</span>
              )}
            </div>
 ...
 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
      ...
      <section className=" lg:hidden w-full bg-[#EBEEFF] pt-10 overflow-hidden relative">
            ...
            <div className="px-5 text-[#1B2B6B]">
                ...
                Your safety was violated. <br /> <span className="font-bold">You deserve support</span> and a <br />
                <span className="font-bold">path forward.</span>
                </h2>
...
>
      ...
      <section className=" lg:hidden relative w-full bg-[#EBEEFF] overflow-hidden">
            ...
            <div className="px-5 pt-8 pb-6 text-[#162766]">
                ...
                You don't have to carry this alone. We help you 
                <span className="font-semibold"> take the next step.</span>
...
>
                ...
                Many attorneys work on contingency, meaning you typically pay nothing unless compensation is recovered. 
                </p>
            </div>
      ...
      <section className=" lg:hidden relative w-full bg-white px-5 pt-10 pb-20 overflow-hidden">
            ...
            <h2 className="text-[30px] font-lato leading-tight font-normal text-[#162766] mb-4">
                <span className="font-semibold">We’ll help you <span className="font-normal">understand what qualifies,</span>  step by step.</span>
            </h2>
      ...
      <section className=" lg:hidden relative w-full bg-[#162B6F] py-10">
            ...
            <div className="px-5 text-center">
                ...
                Ready To Get a Free <br />
                 Rideshare Sexual Assault <br /> Lawsuit Review?
                </h2>
...
export default RideshareSexualAssaultLawsuitC;