...
const SocialMediaAddictionLawsuitB = () => {
  // Meta Pixel ID
...
const getUSTimezone = (tz) => {
  ...
  try {
    ...
    const body = {
      ...
      formPath: "/social-media-addiction-lawsuit-b-kq",
      vertical:LEAD_GENERATION_VERTICALS.SOCIAL_MEDIA_ADDICTION,
      formname: "Social Media Addiction Lawsuit Form B KQ",
...
>
                ...
                <p className="text-[13.5px] text-gray-300 mb-4 leading-relaxed tracking-wide">
                  ...
                  ✅ Criteria-based review focused on age, usage time, harm timeline, and treatment  <br />
                  ✅ No upfront cost to check if you qualify <br />
                  ✅ If eligible, we connect you with an attorney for next-step guidance <br /> <br />
                </p>
...
leading-tight font-semibold text-[#162766] mb-4">
                    Understanding Social Media Addiction, Teen Harm, and the Social Media Addiction Lawsuit
                </h2>
...
">
                    Social platforms use features like infinite feeds, autoplay, notifications, and algorithms to keep teens engaged. Heavy daily use can become compulsive and harm sleep, mood, school performance, and mental health.
...
">
                    Social media addiction lawsuits allege major platforms failed to warn families or protect minors from known risks, especially for harms after 2012. Many claims involve documented treatment and, in some cases, online predator abuse, sextortion, or exploitation.
                </p>
...
">
                    Social Media Addiction Lawsuit Eligibility Requirements for Compensation
                </h2>
...
">
                    <li className="flex gap-3">
                        ●
                    <span>
                     Your child is still within the legal time limit to file (usually under 18.5–19.5, depending on the state).
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        They started using the platform as a minor (before 18).  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        They used it heavily (about 3+ hours a day across apps).  
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        The harm happened after 2012 (and you have a timeline of when it started).
                    </span>
                    </li>
                    ...
                    <li className="flex gap-3">
                        ●
                    <span>
                        There was serious harm, treatment, and a parent/guardian can file (self-harm/suicidal thoughts, eating disorder, substance/drug use, or online predator abuse, and they got medical/therapy help).  
                    </span>
                    </li>
...
font-lato
    ...
    xl:text-[17px]">
                    ...
                    quick, confidential form to see if you qualify for a social media addiction
...
leading-relaxed
 text-[#162766] mb-2">
  ...
  "
>
                    Get matched with experienced social media addiction lawyers.
                    </p>
                </div>
...
>
            ...
            confidential form to see if you qualify for a social media addiction lawsuit. Our
...
export default SocialMediaAddictionLawsuitB;
