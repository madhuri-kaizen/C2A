...
export const content = {
  ...
  realStories: [
    {
      name: "Clayton Tucholke:",
      story:
        " He used Paraquat on his farm in South Dakota, which led to his diagnosis of Parkinson’s disease. Clayton was forced to give up farming and is suing the manufacturer to help prevent this from happening to others. ",
    },
    {
      name: "Frank Garcia:",
      story:
        " Frank used Paraquat for farming on his Arizona farm. His wife has developed Parkinson’s disease. He has filed a lawsuit alleging that the manufacturers knew about the side effects. ",
    },
  ],
  ...
  eligibilityPoints: [
    {
      description:
        "You were exposed to paraquat through farming, spraying, or occupational use ",
    },
    {
      description: "You have been diagnosed with Parkinson’s disease ",
    },
    {
      description: "You can document exposure history and medical records ",
    },
    {
      description:
  ...
  healthRisks: [
    {
      description:
        "Increased Parkinson’s risk among agricultural workers using paraquat ",
    },
    {
      description: "Higher risk with long-term or repeated exposure  ",
    },
    {
      description:
        "Strong biological evidence linking paraquat to neurodegeneration ",
    },
    {
      description:
        "This scientific evidence forms the backbone of current paraquat lawsuit settlement claims. ",
    },
  ],
  otherRisks: [
    {
  ...
  mdllitigationPoints: [
    {
      description: "Review your eligibility at no upfront cost ",
    },
    {
      description: "Gather medical and occupational evidence ",
    },
    {
      description: "File claims and negotiate settlements ",
    },
    {
  ...
  settlementsPoints: [
    {
      title: "Medical Expenses",
      description:
        "Coverage for past, current, and future treatment costs related to Paraquat exposure.  ",
    },
    {
      title: "Lost Wages",
      description:
    ...
    },
    {
      title: "Pain and Suffering",
      description:
        "Damages for physical pain and emotional distress caused by health issues.  ",
    },
    {
      title: "Wrongful Death",
      description:
        "Benefits for family members if a loved one died from Paraquat-related conditions. ",
    },
    {
      title: "Punitive Damages",
      description:
        "Financial penalties aimed at deterring the manufacturer from future negligence.",
    },
  ],

  pageContent: {
    mainTitle: "What is the Paraquat Parkinson’s Disease Lawsuit?",
    mainParagraphs: [
      "The paraquat lawsuit involves individuals diagnosed with Parkinson’s disease after exposure to the highly toxic herbicide paraquat. Scientific studies and legal claims now link paraquat exposure to an increased risk of Parkinson’s disease, leading to thousands of lawsuits across the United States. ",
      "If you or a loved one worked in farming, landscaping, or agricultural spraying and later developed Parkinson’s disease, you may be eligible to pursue compensation. ",
      "The paraquat Parkinson’s disease lawsuit is a mass tort legal action filed against manufacturers such as Syngenta and Chevron. Plaintiffs allege these companies failed to warn users about the serious neurological risks associated with paraquat exposure. More than 6,000 lawsuits have been filed against Syngenta, seeking justice for those who are affected.   ",
      "Lawsuits claim that long-term or repeated exposure to paraquat significantly increases the risk of Parkinson’s disease and that manufacturers knew, or should have known, about these dangers. ",
      "What is Paraquat?  ",
      "Paraquat is a fast-acting herbicide widely used to control weeds and grasses in agriculture. Despite being banned in more than 30 countries, it remains legal for restricted use in the United States. ",
    ...
    allegationsSubtitle:
      "You may qualify for a paraquat herbicide lawsuit if: ",

    allegationsParagraph:
      "Family members may also be eligible to file wrongful death claims if a loved one passed away due to Parkinson’s complications. ",

    healthRisksTitle: "Paraquat Exposure & Parkinson’s Disease Risk Explained ",
    healthRisksParagraph:
      "Medical research has found that paraquat crosses the blood-brain barrier and damages dopamine-producing neurons, key indicators in Parkinson’s disease development. ",

    healthRiskSubtitle: "Studies show: ",

    otherRisksTitle: "What are the Other Health Risks of Paraquat? ",

    otherRisksParagraph:
      "Apart from Parkinson’s disease, Paraquat exposure may also lead to cardiovascular problems, respiratory complications, and kidney failure. ",
    otherRisksSubtitle:
      "Health risks associated with Paraquat exposure include: ",

    mdllitigationTitle:
      "Finding the Best Paraquat Lawsuit Attorneys & Lawyers  ",

    mdllitigationParagraph:
      "Working with experienced paraquat lawyers significantly improves your chances of securing fair compensation. These cases involve complex medical evidence, corporate liability, and federal court procedures. Top paraquat lawsuit attorneys can: ",

    mdllitigationSubtitle:
      "Connect 2 Attorney helps connect victims with trusted paraquat attorneys nationwide who focus exclusively on toxic exposure and mass tort litigation.  ",
    ...
    settlementsTitle:
      "Paraquat Settlements & Compensation Claims: What to Expect  ",
    settlementsParagraph:
      "Exposure to Paraquat can lead to physical pain, emotional distress, and financial burdens. Many victims struggle with medical bills, lost income, and the impact on their families. Compensation can range from $10,000 to $2 million, depending on the extent of your damages.   ",
    settlementsSubtitle: "You may be eligible for:  ",

    realStoriesTitle: "Real Stories Behind Lawsuit ",

    stepsTitle: "How to File a Paraquat Lawsuit with Connect2Attorney?",
    stepsParagraph:
      "Connect2Attorney guides you through the process of filing a Paraquat Parkinson’s disease lawsuit against the responsible party, in just three simple steps: ",
  },
...
const TALCUM_TOC = [
  { label: "What is Paraquat Lawsuit?", id: "main-title" },
  {
    label: "Paraquat Exposure & Parkinson’s Disease Risk Explained   ",
    id: "health-risks-title",
  },
  {
    label: "What are the Other Health Risks of Paraquat? ",
    id: "other-risks-title",
  },
  {
    label: "Paraquat Lawsuit & Settlement Updates   ",
    id: "settlements-title",
  },
  {
    label: "Finding the Best Paraquat Lawsuit Attorneys & Lawyers   ",
  ...
  {
    label: "How to File a Paraquat Lawsuit with Connect2Attorney?  ",
    id: "steps-title",
  },
  {
    label: "Paraquat Lawsuit Timeline  ",
    id: "timeline-section",
  },
  {
...
const LawsuitsLegalPage = () => {
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 max-w-[946px]">
            ...
            >
              ...
              <br />
               <p className="font-bold">{content.pageContent.mainParagraphs[6]}</p>
              <br />
  ...
  >
    {content.healthRisks.map((item, index) => {
      const isLast = index === content.healthRisks.length - 1;

      return (
        <div key={index} className="flex items-start gap-3">
          {/* Bullet (hide for last item) */}
          {!isLast && (
            <span className="mt-[8px]  text-[#162766] text-[20px]">•</span>
          )}
