...
const steps = [
  ...
  {
    title: "When did you last earn a paycheck?",
    options: ["2022 – 2026", "Prior to 2022", "I have never worked"],
  },
  {
  ...
  },
  {
    ...
    options: ["None", "One", "More than one"],
  },
  {
  ...
  {
    title: "When did you last see a doctor about your condition?",
    options: [
      "Never",
      "In 2026",
...
export default function SSDIEKQ2() {
  const resetFullForm = () => {
    setFormData({
      firstName: "",
      lastName: "",
  ...
  const handleFinalSubmit = async (e) => {
    ...
    try {
      ...
      await Promise.all([
        SSDIESendAdminEmail({ formData: payload }),
        SSDIESendUserEmail({ formData: payload }),
      ]);
