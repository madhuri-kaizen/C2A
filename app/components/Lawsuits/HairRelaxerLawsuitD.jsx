...
const HairRelaxerLawsuitD = () => {
  // Meta Pixel ID
  const META_PIXEL_ID = "1309258731015679"; //800190089764645 input pixel id 
  ...
  const createEarlyLead = async ({ fullName, phone, email = "" }) => {
    ...
    try {
      ...
      const body = {
        ...
        formPath: "/hair-relaxer-lawsuit-d",
        vertical: LEAD_GENERATION_VERTICALS.HAIR_RELAXER,
        formname: "Hair Relaxer Lawsuit D Lander",
  ...
  const updateLeadEmail = async ({
    ...
    try {
      ...
      const body = {
        ...
        brandName: "Project 6",
        websiteName: "  Connect2Attorney",
        formname: "Hair Relaxer Lawsuit Lander D",
        isPartialSubmission: true,
        vertical: LEAD_GENERATION_VERTICALS.HAIR_RELAXER,
        data: {
          name: cleanName,
  ...
  const sendToRetellCRM = async ({ payload }) => {
    try {
      ...
      const retellPayload = {
        ...
        vertical: LEAD_GENERATION_VERTICALS.HAIR_RELAXER,
        formPath: '/hair-relaxer-lawsuit-d',
        formname: 'Hair Relaxer Lawsuit Form D',
        data: {
          submissionDate: new Date().toLocaleString(),
            ...
            <div className="pt-0 mt-20 text-white flex justify-center">
              <div className=" max-w-[720px]">
                 <h1 className="text-[32px] sm:text-[34px] md:text-[38px] lg:text-[42px] xl:text-[46px] leading-snug font-semibold mb-4">
                  Hair Relaxer Lawsuit: Diagnosed With Uterine, Ovarian, or Endometrial Cancer After Use? <span className="bg-[#162766] text-[#F8D216] px-3 py-[3px] rounded-md inline-block">
                    You May Qualify
                  </span>
                ...
                <p className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed tracking-wide text-white mb-4">
                  Free, confidential case review. If you’re a woman diagnosed with uterine, ovarian, or endometrial cancer after hair relaxer use, you may qualify. Check now before deadlines run out.
                </p>
                 ...
                 <ul className="mt-6 space-y-4 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] xl:text-[19px] text-white">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Diagnosed in <span className="font-semibold">2010</span> or later with uterine, ovarian, or endometrial cancer <span className="font-semibold">(age 59 or younger)</span>
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <span className="font-semibold">4+</span>  continuous years of relaxer use and 4+ applications per year during highest-use period
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Diagnosis within <span className="font-semibold">10 years of last use</span>  and you can name the brand (formaldehyde/phthalates)
                    </span>
                  </li>
                </ul>
              </div>
...
">
                <span className="font-bold">        Q1. </span> Have you been diagnosed with any of the following?
                      ...
                      <select
                        ...
                        className={`w-full border rounded-md px-3 py-3 text-[13px] ${desktopTouched.q1 && desktopErrors.q1
                          ? "border-red-500 focus:border-red-500"
                          : "border-[#D7DBEA]"
                          }`}
                      >
...
">
            ...
            <h2 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
              What a Hair Relaxer Cancer Lawsuit Claim May Include
            </h2>
            ...
            <p className="text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed text-[#5A627A] mb-5 max-w-[820px]">
              If you meet the criteria, your claim may pursue compensation for the medical
              and personal impact of a cancer diagnosis after prolonged relaxer use.

              <span className="font-semibold"> Depending on your case, damages may include: </span>
            </p>
            ...
            <ul className="space-y-4 text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] font-semibold text-[#162766] mb-12">
              <li className="flex items-start gap-2">
                ...
                Medical costs (treatment, surgery, oncology care, follow-ups)
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
              ...
              <li className="flex items-start gap-2">
                <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                Long-term health impact and reduced quality of life
              </li>
            </ul>

            {/* ===== SECTION 2 ===== */}
            <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
              Hair Relaxer Cancer Claims Focus on High-Use History, Brand Identification, and Diagnosis Timing
            </h3>
            ...
            <div className="space-y-6 text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] leading-relaxed text-[#5A627A] max-w-[820px] mb-12">
              <p>
                Eligibility requires the injured party to be a person with naturally textured or curly hair and a qualifying diagnosis.
              </p>

              <p>
                Claims must involve uterine, ovarian, or endometrial cancer, diagnosed 2010 or later, with the person being 59 or younger at diagnosis.
              </p>

              <p>
                Screening looks closely at exposure: 4 continuous years of relaxer use, 4+ uses per year during the highest-use period, and diagnosis within 10 years of last use.
              </p>

              <p>
                The relaxer brand must be known and linked to formaldehyde or phthalates. Revlon-only use is not accepted, and cases are declined if the person is incarcerated, or cannot confirm a valid U.S. SSN.
              </p>
            </div>

            {/* ===== SECTION 3 ===== */}
            <h3 className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] xl:text-[32px] font-semibold mb-3">
              Qualifying Hair Relaxer Brands Linked to Cancer Lawsuit Claims
            </h3>
            ...
            <ul className="space-y-5 font-semibold text-[16px] sm:text-[17px] md:text-[18px] lg:text-[19px] text-[#162766]">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                Organic Root Stimulator (ORS Olive Oil — used with relaxer)
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
                Mizani Relaxer
...
/>
        ...
        <div className="px-4 pt-12 pb-16 text-white">
           <h1 className="text-[24px] leading-[40px] font-semibold mb-4 md:text-[32px] md:leading-[44px] ">
            Hair Relaxer Lawsuit: Diagnosed With Uterine, Ovarian, or Endometrial Cancer After Use?
            {"  "}{"  "}
...
">Email</label>
 ...
 Q1. </span>   Have you been diagnosed with any of the following?
              ...
              <select
                ...
                className={`w-full border rounded-md px-3 py-3 text-[13px] ${mobileTouched.q1 && mobileErrors.q1
                  ? "border-red-500 focus:border-red-500"
                  : "border-[#D7DBEA]"
                  }`}
              >
        ...
        <div className=" max-w-[720px] px-4 py-10 text-white font-jakarta">
          ...
          <ul className="space-y-7 font-normal text-[14px]">
            <li className="flex items-start gap-3">
              ...
              <span>
                Diagnosed in <span className="font-semibold">2010</span>  or later with uterine, ovarian, or endometrial cancer <span className="font-semibold">(age 59 or younger) </span>
              </span>
            </li>
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                <span className="font-semibold">4+ continuous years</span>  of relaxer use and 4+ applications per year during highest-use period
              </span>
            </li>
      ...
      <section className=" lg:hidden w-full bg-white py-10">
        <div className="px-4 font-jakarta text-[#162766]">
          ...
          <h2 className="text-[24px] font-bold mb-2">
            What a Hair Relaxer Cancer Lawsuit
          </h2>

          <div className="w-full h-0.5 bg-[#e7e9ec] mb-4" />

          <p className="text-[16px] leading-[1.7] text-[#5A627A] mb-4">
            If you meet the criteria, your claim may pursue compensation
            for the medical and personal impact of a cancer diagnosis
            after prolonged relaxer use.

            <span className="font-bold"> Depending on your case, damages may include: </span>
          </p>
          ...
          <h3 className="text-[24px] font-bold mb-4 leading-snug">
            Hair Relaxer Cancer Claims Focus on High-Use History, Brand Identification, and Diagnosis Timing   </h3>
          ...
          <ul className="space-y-3 font-semibold text-[16px]">
            {[
              ...
              "Just For Me",
              "Optimum",
              "Prganic Root Stimulator (ORS Olive Oil used with relaxer)",
              "Mizani Relaxer"
            ].map((item, idx) => (
              <li key={idx} className="flex items-start gap-2">
                <span className="mt-[6px] w-[5px] h-[5px] rounded-full bg-[#162766]" />
...
export default HairRelaxerLawsuitD;